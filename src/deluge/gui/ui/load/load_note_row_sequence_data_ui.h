...
class LoadNoteRowSequenceDataUI final : public LoadUI {
public:
	LoadNoteRowSequenceDataUI() = default;
	...
	// ui
	UIType getUIType() override { return UIType::LOAD_NOTE_ROW_SEQUENCE_DATA; }
...
private:
	Error setupForLoadingNoteRowSequenceData();
	Error currentLabelLoadError = Error::NONE;
};

extern LoadNoteRowSequenceDataUI loadNoteRowSequenceDataUI;
