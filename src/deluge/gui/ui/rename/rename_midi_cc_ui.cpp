...
bool RenameMidiCCUI::opened() {
	...
	MIDIInstrument* midiInstrument = (MIDIInstrument*)getCurrentClip()->output;

	enteredText.set(midiInstrument.modKnobCCAssignments[midiInstrument.modKnobMode * kNumPhysicalModKnobs + midiInstrument.lastModEncoderPressed].cc
