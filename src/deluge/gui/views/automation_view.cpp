...
int32_t AutomationView::getAverageSquareKnobPosition(ModelStackWithAutoParam* modelStack, int32_t xDisplay, int32_t effectiveLength, int32_t xScroll, int32_t xZoom) {
	...
	for (int32_t i = 0; i < numNodesWithinSquare; i++) {
		...
		totalKnobPos = totalKnobPos + modelStack->paramCollection->paramValueToKnobPos(value, modelStack) + kKnobPosOffset;
	}
