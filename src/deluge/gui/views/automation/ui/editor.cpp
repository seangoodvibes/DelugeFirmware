...
void AutomationEditor::initMIDICCShortcutsForAutomation() {
...
void AutomationEditor::initializeView() {
...
void AutomationEditor::focusRegained() {
	if (onArrangerView) {
...
void AutomationEditor::openedInBackground() {
	Clip* clip = getCurrentClip();
	...
	AudioEngine::logAction("AutomationEditor::beginSession 2");
...
void AutomationEditor::graphicsRoutine() {
	if (onArrangerView) {
...
AutomationSubType AutomationEditor::getAutomationSubType() {
	if (onArrangerView) {
...
void AutomationEditor::performActualRender(RGB image[][kDisplayWidth + kSideBarWidth],
...
void AutomationEditor::renderAutomationOverview(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
...
void AutomationEditor::renderAutomationEditor(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                              RGB image[][kDisplayWidth + kSideBarWidth],
                                              uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void AutomationEditor::renderAutomationColumn(ModelStackWithAutoParam* modelStackWithParam,
                                              RGB image[][kDisplayWidth + kSideBarWidth],
                                              uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void AutomationEditor::renderAutomationBipolarSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                                     uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void AutomationEditor::renderAutomationUnipolarSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                                      uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
                                                      int32_t xDisplay, int32_t yDisplay, bool isAutomated,
                                                      int32_t knobPos) {
	RGB& pixel = image[yDisplay][xDisplay];
...
void AutomationEditor::renderNoteEditor(ModelStackWithNoteRow* modelStackWithNoteRow, InstrumentClip* clip,
                                        RGB image[][kDisplayWidth + kSideBarWidth],
...
void AutomationEditor::renderNoteColumn(ModelStackWithNoteRow* modelStackWithNoteRow, InstrumentClip* clip,
                                        RGB image[][kDisplayWidth + kSideBarWidth],
...
void AutomationEditor::renderNoteSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                        uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth], int32_t xDisplay,
...
bool AutomationEditor::renderSidebar(uint32_t whichRows, RGB image[][kDisplayWidth + kSideBarWidth],
                                     uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth]) {
	if (onArrangerView) {
...
void AutomationEditor::renderDisplay(int32_t knobPosLeft, int32_t knobPosRight, bool modEncoderAction) {
...
void AutomationEditor::renderAutomationOverviewDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void AutomationEditor::renderAutomationEditorDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas, Clip* clip,
...
void AutomationEditor::renderNoteEditorDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void AutomationEditor::renderAutomationOverviewDisplay7SEG(Output* output, OutputType outputType) {
	char const* overviewText;
	if (!onArrangerView && (outputType == OutputType::KIT && !getAffectEntire() && !((Kit*)output)->selectedDrum)) {
		overviewText = l10n::get(l10n::String::STRING_FOR_SELECT_A_ROW_OR_AFFECT_ENTIRE);
	}
...
void AutomationEditor::renderAutomationEditorDisplay7SEG(Clip* clip, OutputType outputType, int32_t knobPosLeft,
                                                         bool modEncoderAction) {
	char modelStackMemory[MODEL_STACK_MAX_SIZE];
	ModelStackWithTimelineCounter* modelStack = currentSong->setupModelStackWithCurrentClip(modelStackMemory);
	ModelStackWithAutoParam* modelStackWithParam = nullptr;
...
void AutomationEditor::renderNoteEditorDisplay7SEG(InstrumentClip* clip, OutputType outputType, int32_t knobPosLeft) {
	char modelStackMemory[MODEL_STACK_MAX_SIZE];
	ModelStackWithTimelineCounter* modelStack = currentSong->setupModelStackWithCurrentClip(modelStackMemory);
	bool isKit = outputType == OutputType::KIT;
...
void AutomationEditor::getAutomationParameterName(Clip* clip, OutputType outputType, StringBuf& parameterName) {
...
void AutomationEditor::displayAutomation(bool padSelected, bool updateDisplay) {
...
ActionResult AutomationEditor::buttonAction(hid::Button b, bool on, bool inCardRoutine) {
	if (inCardRoutine) {
...
void AutomationEditor::handleSessionButtonAction(Clip* clip, bool on) {
...
void AutomationEditor::handleKeyboardButtonAction(bool on) {
...
void AutomationEditor::handleClipButtonAction(bool on, bool isAudioClip) {
...
void AutomationEditor::handleCrossScreenButtonAction(bool on) {
...
void AutomationEditor::handleKitButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
...
void AutomationEditor::handleSynthButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		// if you're going to create a new instrument or change output type,
		// reset selection
		initParameterSelection();
...
void AutomationEditor::handleMidiButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
...
void AutomationEditor::handleCVButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		// if you're going to change output type,
		// reset selection
		initParameterSelection();
...
bool AutomationEditor::handleHorizontalEncoderButtonAction(bool on, bool isAudioClip) {
	if (onArrangerView) {
		return true;
	}
	else if (isAudioClip) {
...
bool AutomationEditor::handleBackAndHorizontalEncoderButtonComboAction(Clip* clip, bool on) {
...
void AutomationEditor::handleVerticalEncoderButtonAction(bool on) {
	if (on) {
		if (inNoteEditor()) {
...
void AutomationEditor::handleSelectEncoderButtonAction(bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		initParameterSelection();
		uiNeedsRendering(this);
...
ActionResult AutomationEditor::padAction(int32_t x, int32_t y, int32_t velocity) {
	if (sdRoutineLock) {
		return ActionResult::REMIND_ME_OUTSIDE_CARD_ROUTINE;
	}
...
ActionResult AutomationEditor::handleEditPadAction(ModelStackWithAutoParam* modelStackWithParam,
...
bool AutomationEditor::shortcutPadAction(ModelStackWithAutoParam* modelStackWithParam, Clip* clip, Output* output,
...
bool AutomationEditor::toggleAutomationInterpolation() {
	if (interpolation) {
		interpolation = false;
		initInterpolation();
...
bool AutomationEditor::toggleVelocityPadSelectionMode(SquareInfo& squareInfo) {
...
bool AutomationEditor::toggleAutomationPadSelectionMode(ModelStackWithAutoParam* modelStackWithParam,
...
void AutomationEditor::handleParameterSelection(Clip* clip, Output* output, OutputType outputType, int32_t xDisplay,
                                                int32_t yDisplay) {
...
void AutomationEditor::noteEditPadAction(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void AutomationEditor::velocityPadSelectionAction(ModelStackWithNoteRow* modelStackWithNoteRow, InstrumentClip* clip,
...
void AutomationEditor::velocityEditPadAction(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
                                             InstrumentClip* clip, int32_t x, int32_t y, int32_t velocity,
                                             int32_t effectiveLength, SquareInfo& squareInfo) {
	// save pad selected
	leftPadSelectedX = x;
...
int32_t AutomationEditor::getVelocityFromY(int32_t y) {
	int32_t velocity = std::clamp<int32_t>(nonPatchCablePadPressValues[y], 1, 127);
	return velocity;
}

// convert velocity of a square into y
int32_t AutomationEditor::getYFromVelocity(int32_t velocity) {
...
// add note and set velocity
void AutomationEditor::addNoteWithNewVelocity(int32_t x, int32_t velocity, int32_t newVelocity) {
	if (velocity) {
...
void AutomationEditor::adjustNoteVelocity(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow, int32_t x,
...
void AutomationEditor::setVelocity(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow, int32_t x,
                                   int32_t newVelocity) {
...
void AutomationEditor::setVelocityRamp(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void AutomationEditor::recordNoteEditPadAction(int32_t x, int32_t velocity) {
...
// stores pad presses in the EditPadPresses struct of the instrument clip view
void AutomationEditor::automationEditPadAction(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
bool AutomationEditor::recordAutomationSinglePadPress(int32_t xDisplay, int32_t yDisplay) {
...
ActionResult AutomationEditor::handleMutePadAction(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
...
ActionResult AutomationEditor::handleAuditionPadAction(InstrumentClip* instrumentClip, Output* output,
                                                       OutputType outputType, int32_t y, int32_t velocity) {
	if (onArrangerView) {
		if (onAutomationOverview()) {
...
void AutomationEditor::auditionPadAction(int32_t velocity, int32_t yDisplay, bool shiftButtonDown) {
...
ActionResult AutomationEditor::horizontalEncoderAction(int32_t offset) {
	if (sdRoutineLock) {
...
void AutomationEditor::shiftAutomationHorizontally(ModelStackWithAutoParam* modelStackWithParam, int32_t offset,
...
ActionResult AutomationEditor::verticalEncoderAction(int32_t offset, bool inCardRoutine) {
	if (inCardRoutine) {
		return ActionResult::REMIND_ME_OUTSIDE_CARD_ROUTINE;
	}
...
void AutomationEditor::potentiallyVerticalScrollToSelectedDrum(InstrumentClip* clip, Output* output) {
...
// Not used with Audio Clip Automation View or Arranger Automation View
ActionResult AutomationEditor::scrollVertical(int32_t scrollAmount) {
	InstrumentClip* clip = getCurrentInstrumentClip();
	Output* output = clip->output;
	OutputType outputType = output->type;
...
void AutomationEditor::modEncoderAction(int32_t whichModEncoder, int32_t offset) {
...
bool AutomationEditor::automationModEncoderActionForSelectedPad(ModelStackWithAutoParam* modelStackWithParam,
...
void AutomationEditor::automationModEncoderActionForUnselectedPad(ModelStackWithAutoParam* modelStackWithParam,
                                                                  int32_t whichModEncoder, int32_t offset,
                                                                  int32_t effectiveLength) {
	Clip* clip = getCurrentClip();
...
void AutomationEditor::modEncoderButtonAction(uint8_t whichModEncoder, bool on) {
...
void AutomationEditor::copyAutomation(ModelStackWithAutoParam* modelStackWithParam, Clip* clip, int32_t xScroll,
                                      int32_t xZoom) {
...
void AutomationEditor::pasteAutomation(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                       int32_t effectiveLength, int32_t xScroll, int32_t xZoom) {
	if (!copiedParamAutomation.nodes) {
...
void AutomationEditor::selectEncoderAction(int8_t offset) {
...
void AutomationEditor::selectGlobalParam(int32_t offset, Clip* clip) {
	if (onArrangerView) {
...
void AutomationEditor::selectNonGlobalParam(int32_t offset, Clip* clip) {
...
bool AutomationEditor::selectPatchCable(int32_t offset, Clip* clip) {
	ParamManagerForTimeline* paramManager = clip->getCurrentParamManager();
	if (paramManager) {
		PatchCableSet* set = paramManager->getPatchCableSetAllowJibberish();
		// make sure it's not jiberish
...
bool AutomationEditor::selectPatchCableAtIndex(Clip* clip, PatchCableSet* set, int32_t patchCableIndex,
...
void AutomationEditor::selectMIDICC(int32_t offset, Clip* clip) {
	if (onAutomationOverview()) {
...
int32_t AutomationEditor::getNextSelectedParamArrayPosition(int32_t offset, int32_t lastSelectedParamArrayPosition,
                                                            int32_t numParams) {
	int32_t idx;
...
void AutomationEditor::getLastSelectedParamShortcut(Clip* clip) {
...
void AutomationEditor::getLastSelectedParamArrayPosition(Clip* clip) {
	Output* output = clip->output;
	OutputType outputType = output->type;
...
void AutomationEditor::getLastSelectedNonGlobalParamArrayPosition(Clip* clip) {
...
void AutomationEditor::getLastSelectedGlobalParamArrayPosition(Clip* clip) {
...
void AutomationEditor::noteRowChanged(InstrumentClip* clip, NoteRow* noteRow) {
	instrumentClipView.noteRowChanged(clip, noteRow);
}

// called by playback_handler.cpp
void AutomationEditor::notifyPlaybackBegun() {
...
void AutomationEditor::initParameterSelection(bool updateDisplay) {
	resetShortcutBlinking();
	initPadSelection();
...
void AutomationEditor::initPadSelection() {
	padSelectionOn = false;
	multiPadPressSelected = false;
	multiPadPressActive = false;
	middlePadPressSelected = false;
...
void AutomationEditor::initInterpolation() {
...
ModelStackWithAutoParam* AutomationEditor::getModelStackWithParamForClip(ModelStackWithTimelineCounter* modelStack,
...
int32_t AutomationEditor::getEffectiveLength(ModelStackWithTimelineCounter* modelStack) {
	Clip* clip = getCurrentClip();
	OutputType outputType = clip->output->type;
...
uint32_t AutomationEditor::getMaxLength() {
	if (onArrangerView) {
...
uint32_t AutomationEditor::getMaxZoom() {
	if (onArrangerView) {
...
int32_t AutomationEditor::getNavSysId() const {
	if (onArrangerView) {
...
uint32_t AutomationEditor::getSquareWidth(int32_t square, int32_t effectiveLength, int32_t xScroll, int32_t xZoom) {
...
uint32_t AutomationEditor::getMiddlePosFromSquare(int32_t xDisplay, int32_t effectiveLength, int32_t xScroll,
                                                  int32_t xZoom) {
...
int32_t AutomationEditor::getAutomationParameterKnobPos(ModelStackWithAutoParam* modelStack, uint32_t squareStart) {
...
bool AutomationEditor::getAutomationNodeInterpolation(ModelStackWithAutoParam* modelStack, int32_t pos, bool reversed) {
...
void AutomationEditor::setAutomationParameterValue(ModelStackWithAutoParam* modelStack, int32_t knobPos,
...
void AutomationEditor::setAutomationKnobIndicatorLevels(ModelStackWithAutoParam* modelStack, int32_t knobPosLeft,
                                                        int32_t knobPosRight) {
...
void AutomationEditor::updateAutomationModPosition(ModelStackWithAutoParam* modelStack, uint32_t squareStart,
...
void AutomationEditor::handleAutomationSinglePadPress(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
// using the grid
void AutomationEditor::handleAutomationParameterChange(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
int32_t AutomationEditor::calculateAutomationKnobPosForPadPress(ModelStackWithAutoParam* modelStackWithParam,
...
// presses
int32_t AutomationEditor::calculateAutomationKnobPosForMiddlePadPress(params::Kind kind, int32_t yDisplay) {
	int32_t newKnobPos = 0;
...
int32_t AutomationEditor::calculateAutomationKnobPosForSinglePadPress(params::Kind kind, int32_t yDisplay) {
	int32_t newKnobPos = 0;
...
void AutomationEditor::handleAutomationMultiPadPress(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
void AutomationEditor::renderAutomationDisplayForMultiPadPress(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                                               int32_t effectiveLength, int32_t xScroll, int32_t xZoom,
...
int32_t AutomationEditor::calculateAutomationKnobPosForModEncoderTurn(ModelStackWithAutoParam* modelStackWithParam,
...
bool AutomationEditor::onAutomationOverview() {
	return (!inAutomationEditor() && !inNoteEditor());
}

bool AutomationEditor::inAutomationEditor() {
	if (onArrangerView) {
...
void AutomationEditor::setAutomationParamType() {
	automationParamType = AutomationParamType::PER_SOUND;
	if (!inAutomationEditor()) {
		Clip* clip = getCurrentClip();
...
void AutomationEditor::blinkShortcuts() {
	if (getCurrentUI() == this) {
...
void AutomationEditor::resetShortcutBlinking() {
	memset(soundEditor.sourceShortcutBlinkFrequencies, 255, sizeof(soundEditor.sourceShortcutBlinkFrequencies));
	resetParameterShortcutBlinking();
	resetInterpolationShortcutBlinking();
	resetPadSelectionShortcutBlinking();
...
void AutomationEditor::resetParameterShortcutBlinking() {
...
void AutomationEditor::resetInterpolationShortcutBlinking() {
	uiTimerManager.unsetTimer(TimerName::INTERPOLATION_SHORTCUT_BLINK);
	interpolationShortcutBlinking = false;
}

void AutomationEditor::blinkInterpolationShortcut() {
...
void AutomationEditor::resetPadSelectionShortcutBlinking() {
	uiTimerManager.unsetTimer(TimerName::PAD_SELECTION_SHORTCUT_BLINK);
	padSelectionShortcutBlinking = false;
}

void AutomationEditor::blinkPadSelectionShortcut() {
