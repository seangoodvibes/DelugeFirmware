...
void AutomationOverview::renderAutomationEditorDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
// stores pad presses in the EditPadPresses struct of the instrument clip view
void AutomationOverview::automationEditPadAction(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
void AutomationOverview::pasteAutomation(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                         int32_t effectiveLength, int32_t xScroll, int32_t xZoom) {
	if (!copiedParamAutomation.nodes) {
...
bool AutomationOverview::getAutomationNodeInterpolation(ModelStackWithAutoParam* modelStack, int32_t pos,
                                                        bool reversed) {
...
void AutomationOverview::renderAutomationDisplayForMultiPadPress(ModelStackWithAutoParam* modelStackWithParam,
