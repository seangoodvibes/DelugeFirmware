...
class AutomationViewCvInstrumentClip final : public AutomationViewInstrumentClip {
public:
	AutomationViewCvInstrumentClip();
};

//}; // namespace deluge::gui::views

// TODO: should get moved into namespace once project namespacing is complete
extern AutomationViewCvInstrumentClip automationViewCvInstrumentClip;
