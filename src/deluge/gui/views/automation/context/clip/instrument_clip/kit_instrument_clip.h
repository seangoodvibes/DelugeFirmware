...
class AutomationViewKitInstrumentClip : public AutomationViewInstrumentClip {
public:
	AutomationViewKitInstrumentClip();
};

//}; // namespace deluge::gui::views

// TODO: should get moved into namespace once project namespacing is complete
extern AutomationViewKitInstrumentClip automationViewKitInstrumentClip;
