...
class AutomationViewMidiInstrumentClip final : public AutomationViewInstrumentClip {
public:
	AutomationViewMidiInstrumentClip();
};

//}; // namespace deluge::gui::views

// TODO: should get moved into namespace once project namespacing is complete
extern AutomationViewMidiInstrumentClip automationViewMidiInstrumentClip;
