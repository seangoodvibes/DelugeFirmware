...
#include "gui/views/automation/overview.h"
...
void AutomationOverview::initMIDICCShortcutsForAutomation() {
...
bool AutomationOverview::opened() {
	initializeView();
...
void AutomationOverview::initializeView() {
...
void AutomationOverview::focusRegained() {
	if (onArrangerView) {
...
void AutomationOverview::openedInBackground() {
	Clip* clip = getCurrentClip();
	...
	AudioEngine::logAction("AutomationOverview::beginSession 2");
...
void AutomationOverview::graphicsRoutine() {
	if (onArrangerView) {
...
AutomationSubType AutomationOverview::getAutomationSubType() {
	if (onArrangerView) {
...
// rendering
bool AutomationOverview::possiblyRefreshAutomationEditorGrid(Clip* clip, params::Kind paramKind, int32_t paramID) {
...
bool AutomationOverview::renderMainPads(uint32_t whichRows, RGB image[][kDisplayWidth + kSideBarWidth],
...
void AutomationOverview::performActualRender(RGB image[][kDisplayWidth + kSideBarWidth],
...
void AutomationOverview::renderAutomationOverview(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
...
void AutomationOverview::renderAutomationEditor(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
void AutomationOverview::renderAutomationColumn(ModelStackWithAutoParam* modelStackWithParam,
                                            RGB image[][kDisplayWidth + kSideBarWidth],
...
void AutomationOverview::renderAutomationBipolarSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                                   uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void AutomationOverview::renderAutomationUnipolarSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                                    uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
                                                    int32_t xDisplay, int32_t yDisplay, bool isAutomated,
                                                    int32_t knobPos) {
	RGB& pixel = image[yDisplay][xDisplay];
...
void AutomationOverview::renderNoteEditor(ModelStackWithNoteRow* modelStackWithNoteRow, InstrumentClip* clip,
                                      RGB image[][kDisplayWidth + kSideBarWidth],
                                      uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth], int32_t renderWidth,
                                      int32_t xScroll, uint32_t xZoom, int32_t effectiveLength, int32_t xDisplay,
...
void AutomationOverview::renderNoteColumn(ModelStackWithNoteRow* modelStackWithNoteRow, InstrumentClip* clip,
                                      RGB image[][kDisplayWidth + kSideBarWidth],
                                      uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth], int32_t xDisplay,
...
void AutomationOverview::renderNoteSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                      uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth], int32_t xDisplay,
...
void AutomationOverview::renderUndefinedArea(int32_t xScroll, uint32_t xZoom, int32_t lengthToDisplay,
                                         RGB image[][kDisplayWidth + kSideBarWidth],
...
bool AutomationOverview::renderSidebar(uint32_t whichRows, RGB image[][kDisplayWidth + kSideBarWidth],
                                   uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth]) {
	if (onArrangerView) {
...
void AutomationOverview::renderDisplay(int32_t knobPosLeft, int32_t knobPosRight, bool modEncoderAction) {
...
void AutomationOverview::renderDisplayOLED(Clip* clip, Output* output, OutputType outputType, int32_t knobPosLeft,
...
void AutomationOverview::renderAutomationOverviewDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void AutomationOverview::renderAutomationEditorDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas, Clip* clip,
...
void AutomationOverview::renderNoteEditorDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void AutomationOverview::renderDisplay7SEG(Clip* clip, Output* output, OutputType outputType, int32_t knobPosLeft,
...
void AutomationOverview::renderAutomationOverviewDisplay7SEG(Output* output, OutputType outputType) {
	char const* overviewText;
	if (!onArrangerView && (outputType == OutputType::KIT && !getAffectEntire() && !((Kit*)output)->selectedDrum)) {
		overviewText = l10n::get(l10n::String::STRING_FOR_SELECT_A_ROW_OR_AFFECT_ENTIRE);
	}
...
void AutomationOverview::renderAutomationEditorDisplay7SEG(Clip* clip, OutputType outputType, int32_t knobPosLeft,
                                                       bool modEncoderAction) {
	char modelStackMemory[MODEL_STACK_MAX_SIZE];
	ModelStackWithTimelineCounter* modelStack = currentSong->setupModelStackWithCurrentClip(modelStackMemory);
	ModelStackWithAutoParam* modelStackWithParam = nullptr;
...
void AutomationOverview::renderNoteEditorDisplay7SEG(InstrumentClip* clip, OutputType outputType, int32_t knobPosLeft) {
	char modelStackMemory[MODEL_STACK_MAX_SIZE];
	ModelStackWithTimelineCounter* modelStack = currentSong->setupModelStackWithCurrentClip(modelStackMemory);
	bool isKit = outputType == OutputType::KIT;
...
void AutomationOverview::getAutomationParameterName(Clip* clip, OutputType outputType, StringBuf& parameterName) {
...
void AutomationOverview::displayAutomation(bool padSelected, bool updateDisplay) {
...
ActionResult AutomationOverview::buttonAction(hid::Button b, bool on, bool inCardRoutine) {
	if (inCardRoutine) {
...
void AutomationOverview::handleSessionButtonAction(Clip* clip, bool on) {
...
void AutomationOverview::handleKeyboardButtonAction(bool on) {
...
void AutomationOverview::handleClipButtonAction(bool on, bool isAudioClip) {
...
void AutomationOverview::handleCrossScreenButtonAction(bool on) {
...
void AutomationOverview::handleKitButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
...
void AutomationOverview::handleSynthButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		// if you're going to create a new instrument or change output type,
		// reset selection
		initParameterSelection();
...
void AutomationOverview::handleMidiButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
...
void AutomationOverview::handleCVButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		// if you're going to change output type,
		// reset selection
		initParameterSelection();
...
bool AutomationOverview::handleHorizontalEncoderButtonAction(bool on, bool isAudioClip) {
...
bool AutomationOverview::handleBackAndHorizontalEncoderButtonComboAction(Clip* clip, bool on) {
...
void AutomationOverview::handleVerticalEncoderButtonAction(bool on) {
	if (on) {
		if (inNoteEditor()) {
...
void AutomationOverview::handleSelectEncoderButtonAction(bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		initParameterSelection();
		uiNeedsRendering(this);
...
ActionResult AutomationOverview::padAction(int32_t x, int32_t y, int32_t velocity) {
	if (sdRoutineLock) {
		return ActionResult::REMIND_ME_OUTSIDE_CARD_ROUTINE;
	}
...
ActionResult AutomationOverview::handleEditPadAction(ModelStackWithAutoParam* modelStackWithParam,
...
bool AutomationOverview::shortcutPadAction(ModelStackWithAutoParam* modelStackWithParam, Clip* clip, Output* output,
...
bool AutomationOverview::toggleAutomationInterpolation() {
	if (interpolation) {
		interpolation = false;
		initInterpolation();
...
bool AutomationOverview::toggleVelocityPadSelectionMode(SquareInfo& squareInfo) {
...
bool AutomationOverview::toggleAutomationPadSelectionMode(ModelStackWithAutoParam* modelStackWithParam,
...
void AutomationOverview::handleParameterSelection(Clip* clip, Output* output, OutputType outputType, int32_t xDisplay,
                                              int32_t yDisplay) {
...
void AutomationOverview::noteEditPadAction(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void AutomationOverview::velocityPadSelectionAction(ModelStackWithNoteRow* modelStackWithNoteRow, InstrumentClip* clip,
...
void AutomationOverview::velocityEditPadAction(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
                                           InstrumentClip* clip, int32_t x, int32_t y, int32_t velocity,
                                           int32_t effectiveLength, SquareInfo& squareInfo) {
	// save pad selected
	leftPadSelectedX = x;
...
int32_t AutomationOverview::getVelocityFromY(int32_t y) {
	int32_t velocity = std::clamp<int32_t>(nonPatchCablePadPressValues[y], 1, 127);
	return velocity;
}

// convert velocity of a square into y
int32_t AutomationOverview::getYFromVelocity(int32_t velocity) {
...
// add note and set velocity
void AutomationOverview::addNoteWithNewVelocity(int32_t x, int32_t velocity, int32_t newVelocity) {
	if (velocity) {
...
void AutomationOverview::adjustNoteVelocity(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow, int32_t x,
...
void AutomationOverview::setVelocity(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow, int32_t x,
                                 int32_t newVelocity) {
...
void AutomationOverview::setVelocityRamp(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void AutomationOverview::recordNoteEditPadAction(int32_t x, int32_t velocity) {
...
// stores pad presses in the EditPadPresses struct of the instrument clip view
void AutomationOverview::automationEditPadAction(ModelStackWithAutoParam* modelStackWithParam, Clip* clip, int32_t xDisplay,
...
bool AutomationOverview::recordAutomationSinglePadPress(int32_t xDisplay, int32_t yDisplay) {
...
ActionResult AutomationOverview::handleMutePadAction(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
...
ActionResult AutomationOverview::handleAuditionPadAction(InstrumentClip* instrumentClip, Output* output,
...
void AutomationOverview::auditionPadAction(int32_t velocity, int32_t yDisplay, bool shiftButtonDown) {
...
ActionResult AutomationOverview::horizontalEncoderAction(int32_t offset) {
	if (sdRoutineLock) {
...
void AutomationOverview::shiftAutomationHorizontally(ModelStackWithAutoParam* modelStackWithParam, int32_t offset,
...
ActionResult AutomationOverview::verticalEncoderAction(int32_t offset, bool inCardRoutine) {
	if (inCardRoutine) {
		return ActionResult::REMIND_ME_OUTSIDE_CARD_ROUTINE;
	}
...
void AutomationOverview::potentiallyVerticalScrollToSelectedDrum(InstrumentClip* clip, Output* output) {
...
// Not used with Audio Clip Automation View or Arranger Automation View
ActionResult AutomationOverview::scrollVertical(int32_t scrollAmount) {
	InstrumentClip* clip = getCurrentInstrumentClip();
	Output* output = clip->output;
	OutputType outputType = output->type;
...
void AutomationOverview::modEncoderAction(int32_t whichModEncoder, int32_t offset) {
...
bool AutomationOverview::automationModEncoderActionForSelectedPad(ModelStackWithAutoParam* modelStackWithParam,
...
void AutomationOverview::automationModEncoderActionForUnselectedPad(ModelStackWithAutoParam* modelStackWithParam,
                                                                int32_t whichModEncoder, int32_t offset,
                                                                int32_t effectiveLength) {
	Clip* clip = getCurrentClip();
...
void AutomationOverview::modEncoderButtonAction(uint8_t whichModEncoder, bool on) {
...
void AutomationOverview::copyAutomation(ModelStackWithAutoParam* modelStackWithParam, Clip* clip, int32_t xScroll,
                                    int32_t xZoom) {
...
void AutomationOverview::pasteAutomation(ModelStackWithAutoParam* modelStackWithParam, Clip* clip, int32_t effectiveLength,
                                     int32_t xScroll, int32_t xZoom) {
	if (!copiedParamAutomation.nodes) {
...
void AutomationOverview::selectEncoderAction(int8_t offset) {
...
void AutomationOverview::selectGlobalParam(int32_t offset, Clip* clip) {
	if (onArrangerView) {
...
void AutomationOverview::selectNonGlobalParam(int32_t offset, Clip* clip) {
...
bool AutomationOverview::selectPatchCable(int32_t offset, Clip* clip) {
	ParamManagerForTimeline* paramManager = clip->getCurrentParamManager();
	if (paramManager) {
		PatchCableSet* set = paramManager->getPatchCableSetAllowJibberish();
		// make sure it's not jiberish
...
bool AutomationOverview::selectPatchCableAtIndex(Clip* clip, PatchCableSet* set, int32_t patchCableIndex,
...
void AutomationOverview::selectMIDICC(int32_t offset, Clip* clip) {
	if (onAutomationOverview()) {
...
int32_t AutomationOverview::getNextSelectedParamArrayPosition(int32_t offset, int32_t lastSelectedParamArrayPosition,
                                                          int32_t numParams) {
	int32_t idx;
...
void AutomationOverview::getLastSelectedParamShortcut(Clip* clip) {
...
void AutomationOverview::getLastSelectedParamArrayPosition(Clip* clip) {
	Output* output = clip->output;
	OutputType outputType = output->type;
...
void AutomationOverview::getLastSelectedNonGlobalParamArrayPosition(Clip* clip) {
...
void AutomationOverview::getLastSelectedGlobalParamArrayPosition(Clip* clip) {
...
void AutomationOverview::noteRowChanged(InstrumentClip* clip, NoteRow* noteRow) {
	instrumentClipView.noteRowChanged(clip, noteRow);
}

// called by playback_handler.cpp
void AutomationOverview::notifyPlaybackBegun() {
...
void AutomationOverview::initParameterSelection(bool updateDisplay) {
	resetShortcutBlinking();
	initPadSelection();
...
void AutomationOverview::initPadSelection() {
...
void AutomationOverview::initInterpolation() {
...
ModelStackWithAutoParam* AutomationOverview::getModelStackWithParamForClip(ModelStackWithTimelineCounter* modelStack,
...
int32_t AutomationOverview::getEffectiveLength(ModelStackWithTimelineCounter* modelStack) {
	Clip* clip = getCurrentClip();
	OutputType outputType = clip->output->type;
...
uint32_t AutomationOverview::getMaxLength() {
	if (onArrangerView) {
...
uint32_t AutomationOverview::getMaxZoom() {
	if (onArrangerView) {
...
int32_t AutomationOverview::getNavSysId() const {
	if (onArrangerView) {
...
uint32_t AutomationOverview::getSquareWidth(int32_t square, int32_t effectiveLength, int32_t xScroll, int32_t xZoom) {
...
uint32_t AutomationOverview::getMiddlePosFromSquare(int32_t xDisplay, int32_t effectiveLength, int32_t xScroll,
                                                int32_t xZoom) {
...
int32_t AutomationOverview::getAutomationParameterKnobPos(ModelStackWithAutoParam* modelStack, uint32_t squareStart) {
...
bool AutomationOverview::getAutomationNodeInterpolation(ModelStackWithAutoParam* modelStack, int32_t pos, bool reversed) {
...
void AutomationOverview::setAutomationParameterValue(ModelStackWithAutoParam* modelStack, int32_t knobPos,
...
void AutomationOverview::setAutomationKnobIndicatorLevels(ModelStackWithAutoParam* modelStack, int32_t knobPosLeft,
                                                      int32_t knobPosRight) {
...
void AutomationOverview::updateAutomationModPosition(ModelStackWithAutoParam* modelStack, uint32_t squareStart,
...
void AutomationOverview::handleAutomationSinglePadPress(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
// using the grid
void AutomationOverview::handleAutomationParameterChange(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
int32_t AutomationOverview::calculateAutomationKnobPosForPadPress(ModelStackWithAutoParam* modelStackWithParam,
...
// presses
int32_t AutomationOverview::calculateAutomationKnobPosForMiddlePadPress(params::Kind kind, int32_t yDisplay) {
	int32_t newKnobPos = 0;
...
int32_t AutomationOverview::calculateAutomationKnobPosForSinglePadPress(params::Kind kind, int32_t yDisplay) {
	int32_t newKnobPos = 0;
...
void AutomationOverview::handleAutomationMultiPadPress(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
void AutomationOverview::renderAutomationDisplayForMultiPadPress(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                                             int32_t effectiveLength, int32_t xScroll, int32_t xZoom,
...
int32_t AutomationOverview::calculateAutomationKnobPosForModEncoderTurn(ModelStackWithAutoParam* modelStackWithParam,
...
bool AutomationOverview::onAutomationOverview() {
	return (!inAutomationEditor() && !inNoteEditor());
}

bool AutomationOverview::inAutomationEditor() {
	if (onArrangerView) {
...
void AutomationOverview::setAutomationParamType() {
	automationParamType = AutomationParamType::PER_SOUND;
	if (!inAutomationEditor()) {
		Clip* clip = getCurrentClip();
...
void AutomationOverview::blinkShortcuts() {
	if (getCurrentUI() == this) {
...
void AutomationOverview::resetShortcutBlinking() {
	memset(soundEditor.sourceShortcutBlinkFrequencies, 255, sizeof(soundEditor.sourceShortcutBlinkFrequencies));
	resetParameterShortcutBlinking();
	resetInterpolationShortcutBlinking();
	resetPadSelectionShortcutBlinking();
...
void AutomationOverview::resetParameterShortcutBlinking() {
...
void AutomationOverview::resetInterpolationShortcutBlinking() {
	uiTimerManager.unsetTimer(TimerName::INTERPOLATION_SHORTCUT_BLINK);
	interpolationShortcutBlinking = false;
}

void AutomationOverview::blinkInterpolationShortcut() {
...
void AutomationOverview::resetPadSelectionShortcutBlinking() {
	uiTimerManager.unsetTimer(TimerName::PAD_SELECTION_SHORTCUT_BLINK);
	padSelectionShortcutBlinking = false;
}

void AutomationOverview::blinkPadSelectionShortcut() {
