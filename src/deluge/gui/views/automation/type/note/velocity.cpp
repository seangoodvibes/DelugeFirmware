...
#include "gui/views/automation/type/note/velocity.h"
...
VelocityNoteAutomation velocityNoteAutomation{};
...
void VelocityNoteAutomation::initMIDICCShortcutsForAutomation() {
...
bool VelocityNoteAutomation::opened() {
	initializeView();
...
void VelocityNoteAutomation::initializeView() {
...
void VelocityNoteAutomation::focusRegained() {
	if (onArrangerView) {
...
void VelocityNoteAutomation::openedInBackground() {
	Clip* clip = getCurrentClip();
	...
	AudioEngine::logAction("VelocityNoteAutomation::beginSession 2");
...
void VelocityNoteAutomation::graphicsRoutine() {
	if (onArrangerView) {
...
AutomationSubType VelocityNoteAutomation::getAutomationSubType() {
	if (onArrangerView) {
...
// rendering
bool VelocityNoteAutomation::possiblyRefreshAutomationEditorGrid(Clip* clip, params::Kind paramKind, int32_t paramID) {
...
bool VelocityNoteAutomation::renderMainPads(uint32_t whichRows, RGB image[][kDisplayWidth + kSideBarWidth],
...
void VelocityNoteAutomation::performActualRender(RGB image[][kDisplayWidth + kSideBarWidth],
                                                 uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void VelocityNoteAutomation::renderAutomationOverview(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
...
void VelocityNoteAutomation::renderAutomationEditor(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                                    RGB image[][kDisplayWidth + kSideBarWidth],
                                                    uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void VelocityNoteAutomation::renderAutomationColumn(ModelStackWithAutoParam* modelStackWithParam,
                                                    RGB image[][kDisplayWidth + kSideBarWidth],
                                                    uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void VelocityNoteAutomation::renderAutomationBipolarSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                                           uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void VelocityNoteAutomation::renderAutomationUnipolarSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                                            uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
                                                            int32_t xDisplay, int32_t yDisplay, bool isAutomated,
                                                            int32_t knobPos) {
	RGB& pixel = image[yDisplay][xDisplay];
...
void VelocityNoteAutomation::renderNoteEditor(ModelStackWithNoteRow* modelStackWithNoteRow, InstrumentClip* clip,
                                              RGB image[][kDisplayWidth + kSideBarWidth],
                                              uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
                                              int32_t renderWidth, int32_t xScroll, uint32_t xZoom,
                                              int32_t effectiveLength, int32_t xDisplay, bool drawUndefinedArea,
...
void VelocityNoteAutomation::renderNoteColumn(ModelStackWithNoteRow* modelStackWithNoteRow, InstrumentClip* clip,
                                              RGB image[][kDisplayWidth + kSideBarWidth],
...
void VelocityNoteAutomation::renderNoteSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                              uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth], int32_t xDisplay,
...
void VelocityNoteAutomation::renderUndefinedArea(int32_t xScroll, uint32_t xZoom, int32_t lengthToDisplay,
                                                 RGB image[][kDisplayWidth + kSideBarWidth],
                                                 uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
bool VelocityNoteAutomation::renderSidebar(uint32_t whichRows, RGB image[][kDisplayWidth + kSideBarWidth],
                                           uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth]) {
	if (onArrangerView) {
...
void VelocityNoteAutomation::renderDisplay(int32_t knobPosLeft, int32_t knobPosRight, bool modEncoderAction) {
...
void VelocityNoteAutomation::renderDisplayOLED(Clip* clip, Output* output, OutputType outputType, int32_t knobPosLeft,
...
void VelocityNoteAutomation::renderAutomationOverviewDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void VelocityNoteAutomation::renderAutomationEditorDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void VelocityNoteAutomation::renderNoteEditorDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void VelocityNoteAutomation::renderDisplay7SEG(Clip* clip, Output* output, OutputType outputType, int32_t knobPosLeft,
...
void VelocityNoteAutomation::renderAutomationOverviewDisplay7SEG(Output* output, OutputType outputType) {
	char const* overviewText;
	if (!onArrangerView && (outputType == OutputType::KIT && !getAffectEntire() && !((Kit*)output)->selectedDrum)) {
		overviewText = l10n::get(l10n::String::STRING_FOR_SELECT_A_ROW_OR_AFFECT_ENTIRE);
	}
...
void VelocityNoteAutomation::renderAutomationEditorDisplay7SEG(Clip* clip, OutputType outputType, int32_t knobPosLeft,
                                                               bool modEncoderAction) {
	char modelStackMemory[MODEL_STACK_MAX_SIZE];
	ModelStackWithTimelineCounter* modelStack = currentSong->setupModelStackWithCurrentClip(modelStackMemory);
	ModelStackWithAutoParam* modelStackWithParam = nullptr;
...
void VelocityNoteAutomation::renderNoteEditorDisplay7SEG(InstrumentClip* clip, OutputType outputType,
                                                         int32_t knobPosLeft) {
	char modelStackMemory[MODEL_STACK_MAX_SIZE];
	ModelStackWithTimelineCounter* modelStack = currentSong->setupModelStackWithCurrentClip(modelStackMemory);
	bool isKit = outputType == OutputType::KIT;
...
void VelocityNoteAutomation::getAutomationParameterName(Clip* clip, OutputType outputType, StringBuf& parameterName) {
...
void VelocityNoteAutomation::displayAutomation(bool padSelected, bool updateDisplay) {
...
ActionResult VelocityNoteAutomation::buttonAction(hid::Button b, bool on, bool inCardRoutine) {
	if (inCardRoutine) {
...
void VelocityNoteAutomation::handleSessionButtonAction(Clip* clip, bool on) {
...
void VelocityNoteAutomation::handleKeyboardButtonAction(bool on) {
...
void VelocityNoteAutomation::handleClipButtonAction(bool on, bool isAudioClip) {
...
void VelocityNoteAutomation::handleCrossScreenButtonAction(bool on) {
...
void VelocityNoteAutomation::handleKitButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
...
void VelocityNoteAutomation::handleSynthButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		// if you're going to create a new instrument or change output type,
		// reset selection
		initParameterSelection();
...
void VelocityNoteAutomation::handleMidiButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
...
void VelocityNoteAutomation::handleCVButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		// if you're going to change output type,
		// reset selection
		initParameterSelection();
...
bool VelocityNoteAutomation::handleHorizontalEncoderButtonAction(bool on, bool isAudioClip) {
	if (onArrangerView) {
		return true;
	}
	else if (isAudioClip) {
...
bool VelocityNoteAutomation::handleBackAndHorizontalEncoderButtonComboAction(Clip* clip, bool on) {
...
void VelocityNoteAutomation::handleVerticalEncoderButtonAction(bool on) {
	if (on) {
		if (inNoteEditor()) {
...
void VelocityNoteAutomation::handleSelectEncoderButtonAction(bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		initParameterSelection();
		uiNeedsRendering(this);
...
ActionResult VelocityNoteAutomation::padAction(int32_t x, int32_t y, int32_t velocity) {
	if (sdRoutineLock) {
		return ActionResult::REMIND_ME_OUTSIDE_CARD_ROUTINE;
	}
...
ActionResult VelocityNoteAutomation::handleEditPadAction(ModelStackWithAutoParam* modelStackWithParam,
...
bool VelocityNoteAutomation::shortcutPadAction(ModelStackWithAutoParam* modelStackWithParam, Clip* clip, Output* output,
...
bool VelocityNoteAutomation::toggleAutomationInterpolation() {
	if (interpolation) {
		interpolation = false;
		initInterpolation();
...
bool VelocityNoteAutomation::toggleVelocityPadSelectionMode(SquareInfo& squareInfo) {
...
bool VelocityNoteAutomation::toggleAutomationPadSelectionMode(ModelStackWithAutoParam* modelStackWithParam,
...
void VelocityNoteAutomation::handleParameterSelection(Clip* clip, Output* output, OutputType outputType,
...
void VelocityNoteAutomation::noteEditPadAction(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void VelocityNoteAutomation::velocityPadSelectionAction(ModelStackWithNoteRow* modelStackWithNoteRow,
                                                        InstrumentClip* clip, int32_t x, int32_t y, int32_t velocity,
                                                        SquareInfo& squareInfo) {
...
void VelocityNoteAutomation::velocityEditPadAction(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
                                                   InstrumentClip* clip, int32_t x, int32_t y, int32_t velocity,
                                                   int32_t effectiveLength, SquareInfo& squareInfo) {
	// save pad selected
	leftPadSelectedX = x;
...
int32_t VelocityNoteAutomation::getVelocityFromY(int32_t y) {
	int32_t velocity = std::clamp<int32_t>(nonPatchCablePadPressValues[y], 1, 127);
	return velocity;
}

// convert velocity of a square into y
int32_t VelocityNoteAutomation::getYFromVelocity(int32_t velocity) {
...
// add note and set velocity
void VelocityNoteAutomation::addNoteWithNewVelocity(int32_t x, int32_t velocity, int32_t newVelocity) {
	if (velocity) {
...
void VelocityNoteAutomation::adjustNoteVelocity(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void VelocityNoteAutomation::setVelocity(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow, int32_t x,
                                         int32_t newVelocity) {
...
void VelocityNoteAutomation::setVelocityRamp(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void VelocityNoteAutomation::recordNoteEditPadAction(int32_t x, int32_t velocity) {
...
// stores pad presses in the EditPadPresses struct of the instrument clip view
void VelocityNoteAutomation::automationEditPadAction(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
bool VelocityNoteAutomation::recordAutomationSinglePadPress(int32_t xDisplay, int32_t yDisplay) {
...
ActionResult VelocityNoteAutomation::handleMutePadAction(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
...
ActionResult VelocityNoteAutomation::handleAuditionPadAction(InstrumentClip* instrumentClip, Output* output,
                                                             OutputType outputType, int32_t y, int32_t velocity) {
	if (onArrangerView) {
		if (onAutomationOverview()) {
...
void VelocityNoteAutomation::auditionPadAction(int32_t velocity, int32_t yDisplay, bool shiftButtonDown) {
...
ActionResult VelocityNoteAutomation::horizontalEncoderAction(int32_t offset) {
	if (sdRoutineLock) {
...
void VelocityNoteAutomation::shiftAutomationHorizontally(ModelStackWithAutoParam* modelStackWithParam, int32_t offset,
...
ActionResult VelocityNoteAutomation::verticalEncoderAction(int32_t offset, bool inCardRoutine) {
	if (inCardRoutine) {
		return ActionResult::REMIND_ME_OUTSIDE_CARD_ROUTINE;
	}
...
void VelocityNoteAutomation::potentiallyVerticalScrollToSelectedDrum(InstrumentClip* clip, Output* output) {
...
// Not used with Audio Clip Automation View or Arranger Automation View
ActionResult VelocityNoteAutomation::scrollVertical(int32_t scrollAmount) {
	InstrumentClip* clip = getCurrentInstrumentClip();
	Output* output = clip->output;
	OutputType outputType = output->type;
...
void VelocityNoteAutomation::modEncoderAction(int32_t whichModEncoder, int32_t offset) {
...
bool VelocityNoteAutomation::automationModEncoderActionForSelectedPad(ModelStackWithAutoParam* modelStackWithParam,
...
void VelocityNoteAutomation::automationModEncoderActionForUnselectedPad(ModelStackWithAutoParam* modelStackWithParam,
                                                                        int32_t whichModEncoder, int32_t offset,
                                                                        int32_t effectiveLength) {
	Clip* clip = getCurrentClip();
...
void VelocityNoteAutomation::modEncoderButtonAction(uint8_t whichModEncoder, bool on) {
...
void VelocityNoteAutomation::copyAutomation(ModelStackWithAutoParam* modelStackWithParam, Clip* clip, int32_t xScroll,
                                            int32_t xZoom) {
...
void VelocityNoteAutomation::pasteAutomation(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                             int32_t effectiveLength, int32_t xScroll, int32_t xZoom) {
	if (!copiedParamAutomation.nodes) {
...
void VelocityNoteAutomation::selectEncoderAction(int8_t offset) {
...
void VelocityNoteAutomation::selectGlobalParam(int32_t offset, Clip* clip) {
	if (onArrangerView) {
...
void VelocityNoteAutomation::selectNonGlobalParam(int32_t offset, Clip* clip) {
...
bool VelocityNoteAutomation::selectPatchCable(int32_t offset, Clip* clip) {
	ParamManagerForTimeline* paramManager = clip->getCurrentParamManager();
	if (paramManager) {
		PatchCableSet* set = paramManager->getPatchCableSetAllowJibberish();
		// make sure it's not jiberish
...
bool VelocityNoteAutomation::selectPatchCableAtIndex(Clip* clip, PatchCableSet* set, int32_t patchCableIndex,
...
void VelocityNoteAutomation::selectMIDICC(int32_t offset, Clip* clip) {
	if (onAutomationOverview()) {
...
int32_t VelocityNoteAutomation::getNextSelectedParamArrayPosition(int32_t offset,
...
void VelocityNoteAutomation::getLastSelectedParamShortcut(Clip* clip) {
...
void VelocityNoteAutomation::getLastSelectedParamArrayPosition(Clip* clip) {
	Output* output = clip->output;
	OutputType outputType = output->type;
...
void VelocityNoteAutomation::getLastSelectedNonGlobalParamArrayPosition(Clip* clip) {
...
void VelocityNoteAutomation::getLastSelectedGlobalParamArrayPosition(Clip* clip) {
...
void VelocityNoteAutomation::noteRowChanged(InstrumentClip* clip, NoteRow* noteRow) {
	instrumentClipView.noteRowChanged(clip, noteRow);
}

// called by playback_handler.cpp
void VelocityNoteAutomation::notifyPlaybackBegun() {
...
void VelocityNoteAutomation::initParameterSelection(bool updateDisplay) {
	resetShortcutBlinking();
	initPadSelection();
...
void VelocityNoteAutomation::initPadSelection() {
	padSelectionOn = false;
	multiPadPressSelected = false;
	multiPadPressActive = false;
	middlePadPressSelected = false;
...
void VelocityNoteAutomation::initInterpolation() {
...
VelocityNoteAutomation::getModelStackWithParamForClip(ModelStackWithTimelineCounter* modelStack, Clip* clip,
...
int32_t VelocityNoteAutomation::getEffectiveLength(ModelStackWithTimelineCounter* modelStack) {
	Clip* clip = getCurrentClip();
	OutputType outputType = clip->output->type;
...
uint32_t VelocityNoteAutomation::getMaxLength() {
	if (onArrangerView) {
...
uint32_t VelocityNoteAutomation::getMaxZoom() {
	if (onArrangerView) {
...
int32_t VelocityNoteAutomation::getNavSysId() const {
	if (onArrangerView) {
...
uint32_t VelocityNoteAutomation::getSquareWidth(int32_t square, int32_t effectiveLength, int32_t xScroll,
                                                int32_t xZoom) {
...
uint32_t VelocityNoteAutomation::getMiddlePosFromSquare(int32_t xDisplay, int32_t effectiveLength, int32_t xScroll,
                                                        int32_t xZoom) {
...
int32_t VelocityNoteAutomation::getAutomationParameterKnobPos(ModelStackWithAutoParam* modelStack,
...
bool VelocityNoteAutomation::getAutomationNodeInterpolation(ModelStackWithAutoParam* modelStack, int32_t pos,
                                                            bool reversed) {
...
void VelocityNoteAutomation::setAutomationParameterValue(ModelStackWithAutoParam* modelStack, int32_t knobPos,
...
void VelocityNoteAutomation::setAutomationKnobIndicatorLevels(ModelStackWithAutoParam* modelStack, int32_t knobPosLeft,
                                                              int32_t knobPosRight) {
...
void VelocityNoteAutomation::updateAutomationModPosition(ModelStackWithAutoParam* modelStack, uint32_t squareStart,
...
void VelocityNoteAutomation::handleAutomationSinglePadPress(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
// using the grid
void VelocityNoteAutomation::handleAutomationParameterChange(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
int32_t VelocityNoteAutomation::calculateAutomationKnobPosForPadPress(ModelStackWithAutoParam* modelStackWithParam,
...
// presses
int32_t VelocityNoteAutomation::calculateAutomationKnobPosForMiddlePadPress(params::Kind kind, int32_t yDisplay) {
	int32_t newKnobPos = 0;
...
int32_t VelocityNoteAutomation::calculateAutomationKnobPosForSinglePadPress(params::Kind kind, int32_t yDisplay) {
	int32_t newKnobPos = 0;
...
void VelocityNoteAutomation::handleAutomationMultiPadPress(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
void VelocityNoteAutomation::renderAutomationDisplayForMultiPadPress(ModelStackWithAutoParam* modelStackWithParam,
...
int32_t
VelocityNoteAutomation::calculateAutomationKnobPosForModEncoderTurn(ModelStackWithAutoParam* modelStackWithParam,
...
bool VelocityNoteAutomation::onAutomationOverview() {
	return (!inAutomationEditor() && !inNoteEditor());
}

bool VelocityNoteAutomation::inAutomationEditor() {
	if (onArrangerView) {
...
void VelocityNoteAutomation::setAutomationParamType() {
	automationParamType = AutomationParamType::PER_SOUND;
	if (!inAutomationEditor()) {
		Clip* clip = getCurrentClip();
...
void VelocityNoteAutomation::blinkShortcuts() {
	if (getCurrentUI() == this) {
...
void VelocityNoteAutomation::resetShortcutBlinking() {
	memset(soundEditor.sourceShortcutBlinkFrequencies, 255, sizeof(soundEditor.sourceShortcutBlinkFrequencies));
	resetParameterShortcutBlinking();
	resetInterpolationShortcutBlinking();
	resetPadSelectionShortcutBlinking();
...
void VelocityNoteAutomation::resetParameterShortcutBlinking() {
...
void VelocityNoteAutomation::resetInterpolationShortcutBlinking() {
	uiTimerManager.unsetTimer(TimerName::INTERPOLATION_SHORTCUT_BLINK);
	interpolationShortcutBlinking = false;
}

void VelocityNoteAutomation::blinkInterpolationShortcut() {
...
void VelocityNoteAutomation::resetPadSelectionShortcutBlinking() {
	uiTimerManager.unsetTimer(TimerName::PAD_SELECTION_SHORTCUT_BLINK);
	padSelectionShortcutBlinking = false;
}

void VelocityNoteAutomation::blinkPadSelectionShortcut() {
