...
class GlobalEffectableParameterAutomation final : public ParameterAutomation {
public:
	GlobalEffectableParameterAutomation();
...
extern GlobalEffectableParameterAutomation globalEffectableParameterAutomation;
