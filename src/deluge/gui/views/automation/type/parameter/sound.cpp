...
#include "gui/views/automation/type/parameter/sound.h"
...
SoundParameterAutomation soundParameterAutomation{};
...
void SoundParameterAutomation::initMIDICCShortcutsForAutomation() {
...
bool SoundParameterAutomation::opened() {
	initializeView();
...
void SoundParameterAutomation::initializeView() {
...
void SoundParameterAutomation::focusRegained() {
	if (onArrangerView) {
...
void SoundParameterAutomation::openedInBackground() {
	Clip* clip = getCurrentClip();
	...
	AudioEngine::logAction("SoundParameterAutomation::beginSession 2");
...
void SoundParameterAutomation::graphicsRoutine() {
	if (onArrangerView) {
...
AutomationSubType SoundParameterAutomation::getAutomationSubType() {
	if (onArrangerView) {
...
// rendering
bool SoundParameterAutomation::possiblyRefreshAutomationEditorGrid(Clip* clip, params::Kind paramKind,
                                                                   int32_t paramID) {
...
bool SoundParameterAutomation::renderMainPads(uint32_t whichRows, RGB image[][kDisplayWidth + kSideBarWidth],
...
void SoundParameterAutomation::performActualRender(RGB image[][kDisplayWidth + kSideBarWidth],
                                                   uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void SoundParameterAutomation::renderAutomationOverview(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
...
void SoundParameterAutomation::renderAutomationEditor(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                                      RGB image[][kDisplayWidth + kSideBarWidth],
                                                      uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void SoundParameterAutomation::renderAutomationColumn(ModelStackWithAutoParam* modelStackWithParam,
                                                      RGB image[][kDisplayWidth + kSideBarWidth],
                                                      uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void SoundParameterAutomation::renderAutomationBipolarSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                                             uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void SoundParameterAutomation::renderAutomationUnipolarSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                                              uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
                                                              int32_t xDisplay, int32_t yDisplay, bool isAutomated,
                                                              int32_t knobPos) {
	RGB& pixel = image[yDisplay][xDisplay];
...
void SoundParameterAutomation::renderNoteEditor(ModelStackWithNoteRow* modelStackWithNoteRow, InstrumentClip* clip,
                                                RGB image[][kDisplayWidth + kSideBarWidth],
                                                uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
                                                int32_t renderWidth, int32_t xScroll, uint32_t xZoom,
                                                int32_t effectiveLength, int32_t xDisplay, bool drawUndefinedArea,
...
void SoundParameterAutomation::renderNoteColumn(ModelStackWithNoteRow* modelStackWithNoteRow, InstrumentClip* clip,
                                                RGB image[][kDisplayWidth + kSideBarWidth],
                                                uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void SoundParameterAutomation::renderNoteSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                                uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void SoundParameterAutomation::renderUndefinedArea(int32_t xScroll, uint32_t xZoom, int32_t lengthToDisplay,
                                                   RGB image[][kDisplayWidth + kSideBarWidth],
                                                   uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
bool SoundParameterAutomation::renderSidebar(uint32_t whichRows, RGB image[][kDisplayWidth + kSideBarWidth],
                                             uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth]) {
	if (onArrangerView) {
...
void SoundParameterAutomation::renderDisplay(int32_t knobPosLeft, int32_t knobPosRight, bool modEncoderAction) {
...
void SoundParameterAutomation::renderDisplayOLED(Clip* clip, Output* output, OutputType outputType, int32_t knobPosLeft,
...
void SoundParameterAutomation::renderAutomationOverviewDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void SoundParameterAutomation::renderAutomationEditorDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void SoundParameterAutomation::renderNoteEditorDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void SoundParameterAutomation::renderDisplay7SEG(Clip* clip, Output* output, OutputType outputType, int32_t knobPosLeft,
...
void SoundParameterAutomation::renderAutomationOverviewDisplay7SEG(Output* output, OutputType outputType) {
	char const* overviewText;
	if (!onArrangerView && (outputType == OutputType::KIT && !getAffectEntire() && !((Kit*)output)->selectedDrum)) {
		overviewText = l10n::get(l10n::String::STRING_FOR_SELECT_A_ROW_OR_AFFECT_ENTIRE);
	}
...
void SoundParameterAutomation::renderAutomationEditorDisplay7SEG(Clip* clip, OutputType outputType, int32_t knobPosLeft,
                                                                 bool modEncoderAction) {
	char modelStackMemory[MODEL_STACK_MAX_SIZE];
	ModelStackWithTimelineCounter* modelStack = currentSong->setupModelStackWithCurrentClip(modelStackMemory);
	ModelStackWithAutoParam* modelStackWithParam = nullptr;
...
void SoundParameterAutomation::renderNoteEditorDisplay7SEG(InstrumentClip* clip, OutputType outputType,
                                                           int32_t knobPosLeft) {
	char modelStackMemory[MODEL_STACK_MAX_SIZE];
	ModelStackWithTimelineCounter* modelStack = currentSong->setupModelStackWithCurrentClip(modelStackMemory);
	bool isKit = outputType == OutputType::KIT;
...
void SoundParameterAutomation::getAutomationParameterName(Clip* clip, OutputType outputType, StringBuf& parameterName) {
...
void SoundParameterAutomation::displayAutomation(bool padSelected, bool updateDisplay) {
...
ActionResult SoundParameterAutomation::buttonAction(hid::Button b, bool on, bool inCardRoutine) {
	if (inCardRoutine) {
...
void SoundParameterAutomation::handleSessionButtonAction(Clip* clip, bool on) {
...
void SoundParameterAutomation::handleKeyboardButtonAction(bool on) {
...
void SoundParameterAutomation::handleClipButtonAction(bool on, bool isAudioClip) {
...
void SoundParameterAutomation::handleCrossScreenButtonAction(bool on) {
...
void SoundParameterAutomation::handleKitButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
...
void SoundParameterAutomation::handleSynthButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		// if you're going to create a new instrument or change output type,
		// reset selection
		initParameterSelection();
...
void SoundParameterAutomation::handleMidiButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
...
void SoundParameterAutomation::handleCVButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		// if you're going to change output type,
		// reset selection
		initParameterSelection();
...
bool SoundParameterAutomation::handleHorizontalEncoderButtonAction(bool on, bool isAudioClip) {
	if (onArrangerView) {
		return true;
	}
	else if (isAudioClip) {
...
bool SoundParameterAutomation::handleBackAndHorizontalEncoderButtonComboAction(Clip* clip, bool on) {
...
void SoundParameterAutomation::handleVerticalEncoderButtonAction(bool on) {
	if (on) {
		if (inNoteEditor()) {
...
void SoundParameterAutomation::handleSelectEncoderButtonAction(bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		initParameterSelection();
		uiNeedsRendering(this);
...
ActionResult SoundParameterAutomation::padAction(int32_t x, int32_t y, int32_t velocity) {
	if (sdRoutineLock) {
		return ActionResult::REMIND_ME_OUTSIDE_CARD_ROUTINE;
	}
...
ActionResult SoundParameterAutomation::handleEditPadAction(ModelStackWithAutoParam* modelStackWithParam,
                                                           ModelStackWithNoteRow* modelStackWithNoteRow,
                                                           NoteRow* noteRow, Clip* clip, Output* output,
                                                           OutputType outputType, int32_t effectiveLength, int32_t x,
...
bool SoundParameterAutomation::shortcutPadAction(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                                 Output* output, OutputType outputType, int32_t effectiveLength,
                                                 int32_t x, int32_t y, int32_t velocity, int32_t xScroll, int32_t xZoom,
                                                 SquareInfo& squareInfo) {
	if (velocity) {
...
bool SoundParameterAutomation::toggleAutomationInterpolation() {
	if (interpolation) {
		interpolation = false;
		initInterpolation();
...
bool SoundParameterAutomation::toggleVelocityPadSelectionMode(SquareInfo& squareInfo) {
...
bool SoundParameterAutomation::toggleAutomationPadSelectionMode(ModelStackWithAutoParam* modelStackWithParam,
...
void SoundParameterAutomation::handleParameterSelection(Clip* clip, Output* output, OutputType outputType,
...
void SoundParameterAutomation::noteEditPadAction(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void SoundParameterAutomation::velocityPadSelectionAction(ModelStackWithNoteRow* modelStackWithNoteRow,
                                                          InstrumentClip* clip, int32_t x, int32_t y, int32_t velocity,
                                                          SquareInfo& squareInfo) {
...
void SoundParameterAutomation::velocityEditPadAction(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
                                                     InstrumentClip* clip, int32_t x, int32_t y, int32_t velocity,
                                                     int32_t effectiveLength, SquareInfo& squareInfo) {
	// save pad selected
	leftPadSelectedX = x;
...
int32_t SoundParameterAutomation::getVelocityFromY(int32_t y) {
	int32_t velocity = std::clamp<int32_t>(nonPatchCablePadPressValues[y], 1, 127);
	return velocity;
}

// convert velocity of a square into y
int32_t SoundParameterAutomation::getYFromVelocity(int32_t velocity) {
...
// add note and set velocity
void SoundParameterAutomation::addNoteWithNewVelocity(int32_t x, int32_t velocity, int32_t newVelocity) {
	if (velocity) {
...
void SoundParameterAutomation::adjustNoteVelocity(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void SoundParameterAutomation::setVelocity(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow, int32_t x,
                                           int32_t newVelocity) {
...
void SoundParameterAutomation::setVelocityRamp(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void SoundParameterAutomation::recordNoteEditPadAction(int32_t x, int32_t velocity) {
...
// stores pad presses in the EditPadPresses struct of the instrument clip view
void SoundParameterAutomation::automationEditPadAction(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
bool SoundParameterAutomation::recordAutomationSinglePadPress(int32_t xDisplay, int32_t yDisplay) {
...
ActionResult SoundParameterAutomation::handleMutePadAction(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
...
ActionResult SoundParameterAutomation::handleAuditionPadAction(InstrumentClip* instrumentClip, Output* output,
                                                               OutputType outputType, int32_t y, int32_t velocity) {
	if (onArrangerView) {
		if (onAutomationOverview()) {
...
void SoundParameterAutomation::auditionPadAction(int32_t velocity, int32_t yDisplay, bool shiftButtonDown) {
...
ActionResult SoundParameterAutomation::horizontalEncoderAction(int32_t offset) {
	if (sdRoutineLock) {
...
void SoundParameterAutomation::shiftAutomationHorizontally(ModelStackWithAutoParam* modelStackWithParam, int32_t offset,
...
ActionResult SoundParameterAutomation::verticalEncoderAction(int32_t offset, bool inCardRoutine) {
	if (inCardRoutine) {
		return ActionResult::REMIND_ME_OUTSIDE_CARD_ROUTINE;
	}
...
void SoundParameterAutomation::potentiallyVerticalScrollToSelectedDrum(InstrumentClip* clip, Output* output) {
...
// Not used with Audio Clip Automation View or Arranger Automation View
ActionResult SoundParameterAutomation::scrollVertical(int32_t scrollAmount) {
	InstrumentClip* clip = getCurrentInstrumentClip();
	Output* output = clip->output;
	OutputType outputType = output->type;
...
void SoundParameterAutomation::modEncoderAction(int32_t whichModEncoder, int32_t offset) {
...
bool SoundParameterAutomation::automationModEncoderActionForSelectedPad(ModelStackWithAutoParam* modelStackWithParam,
...
void SoundParameterAutomation::automationModEncoderActionForUnselectedPad(ModelStackWithAutoParam* modelStackWithParam,
                                                                          int32_t whichModEncoder, int32_t offset,
                                                                          int32_t effectiveLength) {
	Clip* clip = getCurrentClip();
...
void SoundParameterAutomation::modEncoderButtonAction(uint8_t whichModEncoder, bool on) {
...
void SoundParameterAutomation::copyAutomation(ModelStackWithAutoParam* modelStackWithParam, Clip* clip, int32_t xScroll,
                                              int32_t xZoom) {
...
void SoundParameterAutomation::pasteAutomation(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                               int32_t effectiveLength, int32_t xScroll, int32_t xZoom) {
	if (!copiedParamAutomation.nodes) {
...
void SoundParameterAutomation::selectEncoderAction(int8_t offset) {
...
void SoundParameterAutomation::selectGlobalParam(int32_t offset, Clip* clip) {
	if (onArrangerView) {
...
void SoundParameterAutomation::selectNonGlobalParam(int32_t offset, Clip* clip) {
...
bool SoundParameterAutomation::selectPatchCable(int32_t offset, Clip* clip) {
	ParamManagerForTimeline* paramManager = clip->getCurrentParamManager();
	if (paramManager) {
		PatchCableSet* set = paramManager->getPatchCableSetAllowJibberish();
		// make sure it's not jiberish
...
bool SoundParameterAutomation::selectPatchCableAtIndex(Clip* clip, PatchCableSet* set, int32_t patchCableIndex,
...
void SoundParameterAutomation::selectMIDICC(int32_t offset, Clip* clip) {
	if (onAutomationOverview()) {
...
int32_t SoundParameterAutomation::getNextSelectedParamArrayPosition(int32_t offset,
...
void SoundParameterAutomation::getLastSelectedParamShortcut(Clip* clip) {
...
void SoundParameterAutomation::getLastSelectedParamArrayPosition(Clip* clip) {
	Output* output = clip->output;
	OutputType outputType = output->type;
...
void SoundParameterAutomation::getLastSelectedNonGlobalParamArrayPosition(Clip* clip) {
...
void SoundParameterAutomation::getLastSelectedGlobalParamArrayPosition(Clip* clip) {
...
void SoundParameterAutomation::noteRowChanged(InstrumentClip* clip, NoteRow* noteRow) {
	instrumentClipView.noteRowChanged(clip, noteRow);
}

// called by playback_handler.cpp
void SoundParameterAutomation::notifyPlaybackBegun() {
...
void SoundParameterAutomation::initParameterSelection(bool updateDisplay) {
	resetShortcutBlinking();
	initPadSelection();
...
void SoundParameterAutomation::initPadSelection() {
	padSelectionOn = false;
	multiPadPressSelected = false;
	multiPadPressActive = false;
	middlePadPressSelected = false;
...
void SoundParameterAutomation::initInterpolation() {
...
SoundParameterAutomation::getModelStackWithParamForClip(ModelStackWithTimelineCounter* modelStack, Clip* clip,
...
int32_t SoundParameterAutomation::getEffectiveLength(ModelStackWithTimelineCounter* modelStack) {
	Clip* clip = getCurrentClip();
	OutputType outputType = clip->output->type;
...
uint32_t SoundParameterAutomation::getMaxLength() {
	if (onArrangerView) {
...
uint32_t SoundParameterAutomation::getMaxZoom() {
	if (onArrangerView) {
...
int32_t SoundParameterAutomation::getNavSysId() const {
	if (onArrangerView) {
...
uint32_t SoundParameterAutomation::getSquareWidth(int32_t square, int32_t effectiveLength, int32_t xScroll,
                                                  int32_t xZoom) {
...
uint32_t SoundParameterAutomation::getMiddlePosFromSquare(int32_t xDisplay, int32_t effectiveLength, int32_t xScroll,
                                                          int32_t xZoom) {
...
int32_t SoundParameterAutomation::getAutomationParameterKnobPos(ModelStackWithAutoParam* modelStack,
...
bool SoundParameterAutomation::getAutomationNodeInterpolation(ModelStackWithAutoParam* modelStack, int32_t pos,
                                                              bool reversed) {
...
void SoundParameterAutomation::setAutomationParameterValue(ModelStackWithAutoParam* modelStack, int32_t knobPos,
...
void SoundParameterAutomation::setAutomationKnobIndicatorLevels(ModelStackWithAutoParam* modelStack,
                                                                int32_t knobPosLeft, int32_t knobPosRight) {
...
void SoundParameterAutomation::updateAutomationModPosition(ModelStackWithAutoParam* modelStack, uint32_t squareStart,
...
void SoundParameterAutomation::handleAutomationSinglePadPress(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                                              int32_t xDisplay, int32_t yDisplay,
                                                              int32_t effectiveLength, int32_t xScroll, int32_t xZoom) {
...
// using the grid
void SoundParameterAutomation::handleAutomationParameterChange(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                                               OutputType outputType, int32_t xDisplay,
...
int32_t SoundParameterAutomation::calculateAutomationKnobPosForPadPress(ModelStackWithAutoParam* modelStackWithParam,
...
// presses
int32_t SoundParameterAutomation::calculateAutomationKnobPosForMiddlePadPress(params::Kind kind, int32_t yDisplay) {
	int32_t newKnobPos = 0;
...
int32_t SoundParameterAutomation::calculateAutomationKnobPosForSinglePadPress(params::Kind kind, int32_t yDisplay) {
	int32_t newKnobPos = 0;
...
void SoundParameterAutomation::handleAutomationMultiPadPress(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                                             int32_t firstPadX, int32_t firstPadY, int32_t secondPadX,
                                                             int32_t secondPadY, int32_t effectiveLength,
...
void SoundParameterAutomation::renderAutomationDisplayForMultiPadPress(ModelStackWithAutoParam* modelStackWithParam,
...
int32_t
SoundParameterAutomation::calculateAutomationKnobPosForModEncoderTurn(ModelStackWithAutoParam* modelStackWithParam,
...
bool SoundParameterAutomation::onAutomationOverview() {
	return (!inAutomationEditor() && !inNoteEditor());
}

bool SoundParameterAutomation::inAutomationEditor() {
	if (onArrangerView) {
...
void SoundParameterAutomation::setAutomationParamType() {
	automationParamType = AutomationParamType::PER_SOUND;
	if (!inAutomationEditor()) {
		Clip* clip = getCurrentClip();
...
void SoundParameterAutomation::blinkShortcuts() {
	if (getCurrentUI() == this) {
...
void SoundParameterAutomation::resetShortcutBlinking() {
	memset(soundEditor.sourceShortcutBlinkFrequencies, 255, sizeof(soundEditor.sourceShortcutBlinkFrequencies));
	resetParameterShortcutBlinking();
	resetInterpolationShortcutBlinking();
	resetPadSelectionShortcutBlinking();
...
void SoundParameterAutomation::resetParameterShortcutBlinking() {
...
void SoundParameterAutomation::resetInterpolationShortcutBlinking() {
	uiTimerManager.unsetTimer(TimerName::INTERPOLATION_SHORTCUT_BLINK);
	interpolationShortcutBlinking = false;
}

void SoundParameterAutomation::blinkInterpolationShortcut() {
...
void SoundParameterAutomation::resetPadSelectionShortcutBlinking() {
	uiTimerManager.unsetTimer(TimerName::PAD_SELECTION_SHORTCUT_BLINK);
	padSelectionShortcutBlinking = false;
}

void SoundParameterAutomation::blinkPadSelectionShortcut() {
