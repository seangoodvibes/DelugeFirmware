...
#include "gui/views/automation/type/parameter/cv.h"
...
CvParameterAutomation cvParameterAutomation{};
...
void CvParameterAutomation::initMIDICCShortcutsForAutomation() {
...
bool CvParameterAutomation::opened() {
	initializeView();
...
void CvParameterAutomation::initializeView() {
...
void CvParameterAutomation::focusRegained() {
	if (onArrangerView) {
...
void CvParameterAutomation::openedInBackground() {
	Clip* clip = getCurrentClip();
	...
	AudioEngine::logAction("CvParameterAutomation::beginSession 2");
...
void CvParameterAutomation::graphicsRoutine() {
	if (onArrangerView) {
...
AutomationSubType CvParameterAutomation::getAutomationSubType() {
	if (onArrangerView) {
...
// rendering
bool CvParameterAutomation::possiblyRefreshAutomationEditorGrid(Clip* clip, params::Kind paramKind, int32_t paramID) {
...
bool CvParameterAutomation::renderMainPads(uint32_t whichRows, RGB image[][kDisplayWidth + kSideBarWidth],
...
void CvParameterAutomation::performActualRender(RGB image[][kDisplayWidth + kSideBarWidth],
...
void CvParameterAutomation::renderAutomationOverview(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
...
void CvParameterAutomation::renderAutomationEditor(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                                   RGB image[][kDisplayWidth + kSideBarWidth],
                                                   uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void CvParameterAutomation::renderAutomationColumn(ModelStackWithAutoParam* modelStackWithParam,
                                                   RGB image[][kDisplayWidth + kSideBarWidth],
                                                   uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void CvParameterAutomation::renderAutomationBipolarSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                                          uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void CvParameterAutomation::renderAutomationUnipolarSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                                           uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
                                                           int32_t xDisplay, int32_t yDisplay, bool isAutomated,
                                                           int32_t knobPos) {
	RGB& pixel = image[yDisplay][xDisplay];
...
void CvParameterAutomation::renderNoteEditor(ModelStackWithNoteRow* modelStackWithNoteRow, InstrumentClip* clip,
                                             RGB image[][kDisplayWidth + kSideBarWidth],
                                             uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
                                             int32_t renderWidth, int32_t xScroll, uint32_t xZoom,
                                             int32_t effectiveLength, int32_t xDisplay, bool drawUndefinedArea,
...
void CvParameterAutomation::renderNoteColumn(ModelStackWithNoteRow* modelStackWithNoteRow, InstrumentClip* clip,
                                             RGB image[][kDisplayWidth + kSideBarWidth],
...
void CvParameterAutomation::renderNoteSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                             uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth], int32_t xDisplay,
...
void CvParameterAutomation::renderUndefinedArea(int32_t xScroll, uint32_t xZoom, int32_t lengthToDisplay,
                                                RGB image[][kDisplayWidth + kSideBarWidth],
                                                uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
bool CvParameterAutomation::renderSidebar(uint32_t whichRows, RGB image[][kDisplayWidth + kSideBarWidth],
                                          uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth]) {
	if (onArrangerView) {
...
void CvParameterAutomation::renderDisplay(int32_t knobPosLeft, int32_t knobPosRight, bool modEncoderAction) {
...
void CvParameterAutomation::renderDisplayOLED(Clip* clip, Output* output, OutputType outputType, int32_t knobPosLeft,
...
void CvParameterAutomation::renderAutomationOverviewDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void CvParameterAutomation::renderAutomationEditorDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void CvParameterAutomation::renderNoteEditorDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void CvParameterAutomation::renderDisplay7SEG(Clip* clip, Output* output, OutputType outputType, int32_t knobPosLeft,
...
void CvParameterAutomation::renderAutomationOverviewDisplay7SEG(Output* output, OutputType outputType) {
	char const* overviewText;
	if (!onArrangerView && (outputType == OutputType::KIT && !getAffectEntire() && !((Kit*)output)->selectedDrum)) {
		overviewText = l10n::get(l10n::String::STRING_FOR_SELECT_A_ROW_OR_AFFECT_ENTIRE);
	}
...
void CvParameterAutomation::renderAutomationEditorDisplay7SEG(Clip* clip, OutputType outputType, int32_t knobPosLeft,
                                                              bool modEncoderAction) {
	char modelStackMemory[MODEL_STACK_MAX_SIZE];
	ModelStackWithTimelineCounter* modelStack = currentSong->setupModelStackWithCurrentClip(modelStackMemory);
	ModelStackWithAutoParam* modelStackWithParam = nullptr;
...
void CvParameterAutomation::renderNoteEditorDisplay7SEG(InstrumentClip* clip, OutputType outputType,
                                                        int32_t knobPosLeft) {
	char modelStackMemory[MODEL_STACK_MAX_SIZE];
	ModelStackWithTimelineCounter* modelStack = currentSong->setupModelStackWithCurrentClip(modelStackMemory);
	bool isKit = outputType == OutputType::KIT;
...
void CvParameterAutomation::getAutomationParameterName(Clip* clip, OutputType outputType, StringBuf& parameterName) {
...
void CvParameterAutomation::displayAutomation(bool padSelected, bool updateDisplay) {
...
ActionResult CvParameterAutomation::buttonAction(hid::Button b, bool on, bool inCardRoutine) {
	if (inCardRoutine) {
...
void CvParameterAutomation::handleSessionButtonAction(Clip* clip, bool on) {
...
void CvParameterAutomation::handleKeyboardButtonAction(bool on) {
...
void CvParameterAutomation::handleClipButtonAction(bool on, bool isAudioClip) {
...
void CvParameterAutomation::handleCrossScreenButtonAction(bool on) {
...
void CvParameterAutomation::handleKitButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
...
void CvParameterAutomation::handleSynthButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		// if you're going to create a new instrument or change output type,
		// reset selection
		initParameterSelection();
...
void CvParameterAutomation::handleMidiButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
...
void CvParameterAutomation::handleCVButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		// if you're going to change output type,
		// reset selection
		initParameterSelection();
...
bool CvParameterAutomation::handleHorizontalEncoderButtonAction(bool on, bool isAudioClip) {
	if (onArrangerView) {
		return true;
	}
	else if (isAudioClip) {
...
bool CvParameterAutomation::handleBackAndHorizontalEncoderButtonComboAction(Clip* clip, bool on) {
...
void CvParameterAutomation::handleVerticalEncoderButtonAction(bool on) {
	if (on) {
		if (inNoteEditor()) {
...
void CvParameterAutomation::handleSelectEncoderButtonAction(bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		initParameterSelection();
		uiNeedsRendering(this);
...
ActionResult CvParameterAutomation::padAction(int32_t x, int32_t y, int32_t velocity) {
	if (sdRoutineLock) {
		return ActionResult::REMIND_ME_OUTSIDE_CARD_ROUTINE;
	}
...
ActionResult CvParameterAutomation::handleEditPadAction(ModelStackWithAutoParam* modelStackWithParam,
...
bool CvParameterAutomation::shortcutPadAction(ModelStackWithAutoParam* modelStackWithParam, Clip* clip, Output* output,
...
bool CvParameterAutomation::toggleAutomationInterpolation() {
	if (interpolation) {
		interpolation = false;
		initInterpolation();
...
bool CvParameterAutomation::toggleVelocityPadSelectionMode(SquareInfo& squareInfo) {
...
bool CvParameterAutomation::toggleAutomationPadSelectionMode(ModelStackWithAutoParam* modelStackWithParam,
...
void CvParameterAutomation::handleParameterSelection(Clip* clip, Output* output, OutputType outputType,
...
void CvParameterAutomation::noteEditPadAction(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void CvParameterAutomation::velocityPadSelectionAction(ModelStackWithNoteRow* modelStackWithNoteRow,
                                                       InstrumentClip* clip, int32_t x, int32_t y, int32_t velocity,
                                                       SquareInfo& squareInfo) {
...
void CvParameterAutomation::velocityEditPadAction(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
                                                  InstrumentClip* clip, int32_t x, int32_t y, int32_t velocity,
                                                  int32_t effectiveLength, SquareInfo& squareInfo) {
	// save pad selected
	leftPadSelectedX = x;
...
int32_t CvParameterAutomation::getVelocityFromY(int32_t y) {
	int32_t velocity = std::clamp<int32_t>(nonPatchCablePadPressValues[y], 1, 127);
	return velocity;
}

// convert velocity of a square into y
int32_t CvParameterAutomation::getYFromVelocity(int32_t velocity) {
...
// add note and set velocity
void CvParameterAutomation::addNoteWithNewVelocity(int32_t x, int32_t velocity, int32_t newVelocity) {
	if (velocity) {
...
void CvParameterAutomation::adjustNoteVelocity(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void CvParameterAutomation::setVelocity(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow, int32_t x,
                                        int32_t newVelocity) {
...
void CvParameterAutomation::setVelocityRamp(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void CvParameterAutomation::recordNoteEditPadAction(int32_t x, int32_t velocity) {
...
// stores pad presses in the EditPadPresses struct of the instrument clip view
void CvParameterAutomation::automationEditPadAction(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
bool CvParameterAutomation::recordAutomationSinglePadPress(int32_t xDisplay, int32_t yDisplay) {
...
ActionResult CvParameterAutomation::handleMutePadAction(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
...
ActionResult CvParameterAutomation::handleAuditionPadAction(InstrumentClip* instrumentClip, Output* output,
                                                            OutputType outputType, int32_t y, int32_t velocity) {
	if (onArrangerView) {
		if (onAutomationOverview()) {
...
void CvParameterAutomation::auditionPadAction(int32_t velocity, int32_t yDisplay, bool shiftButtonDown) {
...
ActionResult CvParameterAutomation::horizontalEncoderAction(int32_t offset) {
	if (sdRoutineLock) {
...
void CvParameterAutomation::shiftAutomationHorizontally(ModelStackWithAutoParam* modelStackWithParam, int32_t offset,
...
ActionResult CvParameterAutomation::verticalEncoderAction(int32_t offset, bool inCardRoutine) {
	if (inCardRoutine) {
		return ActionResult::REMIND_ME_OUTSIDE_CARD_ROUTINE;
	}
...
void CvParameterAutomation::potentiallyVerticalScrollToSelectedDrum(InstrumentClip* clip, Output* output) {
...
// Not used with Audio Clip Automation View or Arranger Automation View
ActionResult CvParameterAutomation::scrollVertical(int32_t scrollAmount) {
	InstrumentClip* clip = getCurrentInstrumentClip();
	Output* output = clip->output;
	OutputType outputType = output->type;
...
void CvParameterAutomation::modEncoderAction(int32_t whichModEncoder, int32_t offset) {
...
bool CvParameterAutomation::automationModEncoderActionForSelectedPad(ModelStackWithAutoParam* modelStackWithParam,
...
void CvParameterAutomation::automationModEncoderActionForUnselectedPad(ModelStackWithAutoParam* modelStackWithParam,
                                                                       int32_t whichModEncoder, int32_t offset,
                                                                       int32_t effectiveLength) {
	Clip* clip = getCurrentClip();
...
void CvParameterAutomation::modEncoderButtonAction(uint8_t whichModEncoder, bool on) {
...
void CvParameterAutomation::copyAutomation(ModelStackWithAutoParam* modelStackWithParam, Clip* clip, int32_t xScroll,
                                           int32_t xZoom) {
...
void CvParameterAutomation::pasteAutomation(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                            int32_t effectiveLength, int32_t xScroll, int32_t xZoom) {
	if (!copiedParamAutomation.nodes) {
...
void CvParameterAutomation::selectEncoderAction(int8_t offset) {
...
void CvParameterAutomation::selectGlobalParam(int32_t offset, Clip* clip) {
	if (onArrangerView) {
...
void CvParameterAutomation::selectNonGlobalParam(int32_t offset, Clip* clip) {
...
bool CvParameterAutomation::selectPatchCable(int32_t offset, Clip* clip) {
	ParamManagerForTimeline* paramManager = clip->getCurrentParamManager();
	if (paramManager) {
		PatchCableSet* set = paramManager->getPatchCableSetAllowJibberish();
		// make sure it's not jiberish
...
bool CvParameterAutomation::selectPatchCableAtIndex(Clip* clip, PatchCableSet* set, int32_t patchCableIndex,
...
void CvParameterAutomation::selectMIDICC(int32_t offset, Clip* clip) {
	if (onAutomationOverview()) {
...
int32_t CvParameterAutomation::getNextSelectedParamArrayPosition(int32_t offset, int32_t lastSelectedParamArrayPosition,
                                                                 int32_t numParams) {
	int32_t idx;
...
void CvParameterAutomation::getLastSelectedParamShortcut(Clip* clip) {
...
void CvParameterAutomation::getLastSelectedParamArrayPosition(Clip* clip) {
	Output* output = clip->output;
	OutputType outputType = output->type;
...
void CvParameterAutomation::getLastSelectedNonGlobalParamArrayPosition(Clip* clip) {
...
void CvParameterAutomation::getLastSelectedGlobalParamArrayPosition(Clip* clip) {
...
void CvParameterAutomation::noteRowChanged(InstrumentClip* clip, NoteRow* noteRow) {
	instrumentClipView.noteRowChanged(clip, noteRow);
}

// called by playback_handler.cpp
void CvParameterAutomation::notifyPlaybackBegun() {
...
void CvParameterAutomation::initParameterSelection(bool updateDisplay) {
	resetShortcutBlinking();
	initPadSelection();
...
void CvParameterAutomation::initPadSelection() {
	padSelectionOn = false;
	multiPadPressSelected = false;
	multiPadPressActive = false;
	middlePadPressSelected = false;
...
void CvParameterAutomation::initInterpolation() {
...
ModelStackWithAutoParam* CvParameterAutomation::getModelStackWithParamForClip(ModelStackWithTimelineCounter* modelStack,
...
int32_t CvParameterAutomation::getEffectiveLength(ModelStackWithTimelineCounter* modelStack) {
	Clip* clip = getCurrentClip();
	OutputType outputType = clip->output->type;
...
uint32_t CvParameterAutomation::getMaxLength() {
	if (onArrangerView) {
...
uint32_t CvParameterAutomation::getMaxZoom() {
	if (onArrangerView) {
...
int32_t CvParameterAutomation::getNavSysId() const {
	if (onArrangerView) {
...
uint32_t CvParameterAutomation::getSquareWidth(int32_t square, int32_t effectiveLength, int32_t xScroll,
                                               int32_t xZoom) {
...
uint32_t CvParameterAutomation::getMiddlePosFromSquare(int32_t xDisplay, int32_t effectiveLength, int32_t xScroll,
                                                       int32_t xZoom) {
...
int32_t CvParameterAutomation::getAutomationParameterKnobPos(ModelStackWithAutoParam* modelStack,
...
bool CvParameterAutomation::getAutomationNodeInterpolation(ModelStackWithAutoParam* modelStack, int32_t pos,
                                                           bool reversed) {
...
void CvParameterAutomation::setAutomationParameterValue(ModelStackWithAutoParam* modelStack, int32_t knobPos,
...
void CvParameterAutomation::setAutomationKnobIndicatorLevels(ModelStackWithAutoParam* modelStack, int32_t knobPosLeft,
                                                             int32_t knobPosRight) {
...
void CvParameterAutomation::updateAutomationModPosition(ModelStackWithAutoParam* modelStack, uint32_t squareStart,
...
void CvParameterAutomation::handleAutomationSinglePadPress(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
// using the grid
void CvParameterAutomation::handleAutomationParameterChange(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
int32_t CvParameterAutomation::calculateAutomationKnobPosForPadPress(ModelStackWithAutoParam* modelStackWithParam,
...
// presses
int32_t CvParameterAutomation::calculateAutomationKnobPosForMiddlePadPress(params::Kind kind, int32_t yDisplay) {
	int32_t newKnobPos = 0;
...
int32_t CvParameterAutomation::calculateAutomationKnobPosForSinglePadPress(params::Kind kind, int32_t yDisplay) {
	int32_t newKnobPos = 0;
...
void CvParameterAutomation::handleAutomationMultiPadPress(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
void CvParameterAutomation::renderAutomationDisplayForMultiPadPress(ModelStackWithAutoParam* modelStackWithParam,
...
int32_t CvParameterAutomation::calculateAutomationKnobPosForModEncoderTurn(ModelStackWithAutoParam* modelStackWithParam,
...
bool CvParameterAutomation::onAutomationOverview() {
	return (!inAutomationEditor() && !inNoteEditor());
}

bool CvParameterAutomation::inAutomationEditor() {
	if (onArrangerView) {
...
void CvParameterAutomation::setAutomationParamType() {
	automationParamType = AutomationParamType::PER_SOUND;
	if (!inAutomationEditor()) {
		Clip* clip = getCurrentClip();
...
void CvParameterAutomation::blinkShortcuts() {
	if (getCurrentUI() == this) {
...
void CvParameterAutomation::resetShortcutBlinking() {
	memset(soundEditor.sourceShortcutBlinkFrequencies, 255, sizeof(soundEditor.sourceShortcutBlinkFrequencies));
	resetParameterShortcutBlinking();
	resetInterpolationShortcutBlinking();
	resetPadSelectionShortcutBlinking();
...
void CvParameterAutomation::resetParameterShortcutBlinking() {
...
void CvParameterAutomation::resetInterpolationShortcutBlinking() {
	uiTimerManager.unsetTimer(TimerName::INTERPOLATION_SHORTCUT_BLINK);
	interpolationShortcutBlinking = false;
}

void CvParameterAutomation::blinkInterpolationShortcut() {
...
void CvParameterAutomation::resetPadSelectionShortcutBlinking() {
	uiTimerManager.unsetTimer(TimerName::PAD_SELECTION_SHORTCUT_BLINK);
	padSelectionShortcutBlinking = false;
}

void CvParameterAutomation::blinkPadSelectionShortcut() {
