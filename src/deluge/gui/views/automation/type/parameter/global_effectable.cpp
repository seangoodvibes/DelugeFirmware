...
#include "gui/views/automation/type/parameter/global_effectable.h"
...
GlobalEffectableParameterAutomation globalEffectableParameterAutomation{};
...
void GlobalEffectableParameterAutomation::initMIDICCShortcutsForAutomation() {
...
bool GlobalEffectableParameterAutomation::opened() {
	initializeView();
...
void GlobalEffectableParameterAutomation::initializeView() {
...
void GlobalEffectableParameterAutomation::focusRegained() {
	if (onArrangerView) {
...
void GlobalEffectableParameterAutomation::openedInBackground() {
	Clip* clip = getCurrentClip();
	...
	AudioEngine::logAction("GlobalEffectableParameterAutomation::beginSession 2");
...
void GlobalEffectableParameterAutomation::graphicsRoutine() {
	if (onArrangerView) {
...
AutomationSubType GlobalEffectableParameterAutomation::getAutomationSubType() {
	if (onArrangerView) {
...
// rendering
bool GlobalEffectableParameterAutomation::possiblyRefreshAutomationEditorGrid(Clip* clip, params::Kind paramKind,
                                                                              int32_t paramID) {
...
bool GlobalEffectableParameterAutomation::renderMainPads(uint32_t whichRows, RGB image[][kDisplayWidth + kSideBarWidth],
...
void GlobalEffectableParameterAutomation::performActualRender(RGB image[][kDisplayWidth + kSideBarWidth],
                                                              uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void GlobalEffectableParameterAutomation::renderAutomationOverview(
...
void GlobalEffectableParameterAutomation::renderAutomationEditor(
...
void GlobalEffectableParameterAutomation::renderAutomationColumn(ModelStackWithAutoParam* modelStackWithParam,
                                                                 RGB image[][kDisplayWidth + kSideBarWidth],
                                                                 uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
                                                                 int32_t lengthToDisplay, int32_t xDisplay,
...
void GlobalEffectableParameterAutomation::renderAutomationBipolarSquare(
    RGB image[][kDisplayWidth + kSideBarWidth], uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void GlobalEffectableParameterAutomation::renderAutomationUnipolarSquare(
    RGB image[][kDisplayWidth + kSideBarWidth], uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void GlobalEffectableParameterAutomation::renderNoteEditor(
...
void GlobalEffectableParameterAutomation::renderNoteColumn(ModelStackWithNoteRow* modelStackWithNoteRow,
                                                           InstrumentClip* clip,
                                                           RGB image[][kDisplayWidth + kSideBarWidth],
                                                           uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void GlobalEffectableParameterAutomation::renderNoteSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                                           uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void GlobalEffectableParameterAutomation::renderUndefinedArea(int32_t xScroll, uint32_t xZoom, int32_t lengthToDisplay,
                                                              RGB image[][kDisplayWidth + kSideBarWidth],
                                                              uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
bool GlobalEffectableParameterAutomation::renderSidebar(uint32_t whichRows, RGB image[][kDisplayWidth + kSideBarWidth],
                                                        uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth]) {
	if (onArrangerView) {
...
void GlobalEffectableParameterAutomation::renderDisplay(int32_t knobPosLeft, int32_t knobPosRight,
...
void GlobalEffectableParameterAutomation::renderDisplayOLED(Clip* clip, Output* output, OutputType outputType,
...
void GlobalEffectableParameterAutomation::renderAutomationOverviewDisplayOLED(
    deluge::hid::display::oled_canvas::Canvas& canvas, Output* output, OutputType outputType) {
...
void GlobalEffectableParameterAutomation::renderAutomationEditorDisplayOLED(
...
void GlobalEffectableParameterAutomation::renderNoteEditorDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void GlobalEffectableParameterAutomation::renderDisplay7SEG(Clip* clip, Output* output, OutputType outputType,
...
void GlobalEffectableParameterAutomation::renderAutomationOverviewDisplay7SEG(Output* output, OutputType outputType) {
	char const* overviewText;
	if (!onArrangerView && (outputType == OutputType::KIT && !getAffectEntire() && !((Kit*)output)->selectedDrum)) {
		overviewText = l10n::get(l10n::String::STRING_FOR_SELECT_A_ROW_OR_AFFECT_ENTIRE);
	}
...
void GlobalEffectableParameterAutomation::renderAutomationEditorDisplay7SEG(Clip* clip, OutputType outputType,
                                                                            int32_t knobPosLeft,
                                                                            bool modEncoderAction) {
	char modelStackMemory[MODEL_STACK_MAX_SIZE];
	ModelStackWithTimelineCounter* modelStack = currentSong->setupModelStackWithCurrentClip(modelStackMemory);
...
void GlobalEffectableParameterAutomation::renderNoteEditorDisplay7SEG(InstrumentClip* clip, OutputType outputType,
                                                                      int32_t knobPosLeft) {
	char modelStackMemory[MODEL_STACK_MAX_SIZE];
	ModelStackWithTimelineCounter* modelStack = currentSong->setupModelStackWithCurrentClip(modelStackMemory);
	bool isKit = outputType == OutputType::KIT;
...
void GlobalEffectableParameterAutomation::getAutomationParameterName(Clip* clip, OutputType outputType,
...
void GlobalEffectableParameterAutomation::displayAutomation(bool padSelected, bool updateDisplay) {
...
ActionResult GlobalEffectableParameterAutomation::buttonAction(hid::Button b, bool on, bool inCardRoutine) {
	if (inCardRoutine) {
...
void GlobalEffectableParameterAutomation::handleSessionButtonAction(Clip* clip, bool on) {
...
void GlobalEffectableParameterAutomation::handleKeyboardButtonAction(bool on) {
...
void GlobalEffectableParameterAutomation::handleClipButtonAction(bool on, bool isAudioClip) {
...
void GlobalEffectableParameterAutomation::handleCrossScreenButtonAction(bool on) {
...
void GlobalEffectableParameterAutomation::handleKitButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
...
void GlobalEffectableParameterAutomation::handleSynthButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		// if you're going to create a new instrument or change output type,
		// reset selection
		initParameterSelection();
...
void GlobalEffectableParameterAutomation::handleMidiButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
...
void GlobalEffectableParameterAutomation::handleCVButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		// if you're going to change output type,
		// reset selection
		initParameterSelection();
...
bool GlobalEffectableParameterAutomation::handleHorizontalEncoderButtonAction(bool on, bool isAudioClip) {
	if (onArrangerView) {
		return true;
	}
	else if (isAudioClip) {
...
bool GlobalEffectableParameterAutomation::handleBackAndHorizontalEncoderButtonComboAction(Clip* clip, bool on) {
...
void GlobalEffectableParameterAutomation::handleVerticalEncoderButtonAction(bool on) {
	if (on) {
		if (inNoteEditor()) {
...
void GlobalEffectableParameterAutomation::handleSelectEncoderButtonAction(bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		initParameterSelection();
		uiNeedsRendering(this);
...
ActionResult GlobalEffectableParameterAutomation::padAction(int32_t x, int32_t y, int32_t velocity) {
	if (sdRoutineLock) {
		return ActionResult::REMIND_ME_OUTSIDE_CARD_ROUTINE;
	}
...
ActionResult GlobalEffectableParameterAutomation::handleEditPadAction(ModelStackWithAutoParam* modelStackWithParam,
                                                                      ModelStackWithNoteRow* modelStackWithNoteRow,
...
bool GlobalEffectableParameterAutomation::shortcutPadAction(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                                            Output* output, OutputType outputType,
                                                            int32_t effectiveLength, int32_t x, int32_t y,
...
bool GlobalEffectableParameterAutomation::toggleAutomationInterpolation() {
	if (interpolation) {
		interpolation = false;
		initInterpolation();
...
bool GlobalEffectableParameterAutomation::toggleVelocityPadSelectionMode(SquareInfo& squareInfo) {
...
bool GlobalEffectableParameterAutomation::toggleAutomationPadSelectionMode(ModelStackWithAutoParam* modelStackWithParam,
...
void GlobalEffectableParameterAutomation::handleParameterSelection(Clip* clip, Output* output, OutputType outputType,
...
void GlobalEffectableParameterAutomation::noteEditPadAction(ModelStackWithNoteRow* modelStackWithNoteRow,
...
void GlobalEffectableParameterAutomation::velocityPadSelectionAction(ModelStackWithNoteRow* modelStackWithNoteRow,
                                                                     InstrumentClip* clip, int32_t x, int32_t y,
                                                                     int32_t velocity, SquareInfo& squareInfo) {
...
void GlobalEffectableParameterAutomation::velocityEditPadAction(ModelStackWithNoteRow* modelStackWithNoteRow,
                                                                NoteRow* noteRow, InstrumentClip* clip, int32_t x,
                                                                int32_t y, int32_t velocity, int32_t effectiveLength,
                                                                SquareInfo& squareInfo) {
	// save pad selected
...
int32_t GlobalEffectableParameterAutomation::getVelocityFromY(int32_t y) {
	int32_t velocity = std::clamp<int32_t>(nonPatchCablePadPressValues[y], 1, 127);
	return velocity;
}

// convert velocity of a square into y
int32_t GlobalEffectableParameterAutomation::getYFromVelocity(int32_t velocity) {
...
// add note and set velocity
void GlobalEffectableParameterAutomation::addNoteWithNewVelocity(int32_t x, int32_t velocity, int32_t newVelocity) {
	if (velocity) {
...
void GlobalEffectableParameterAutomation::adjustNoteVelocity(ModelStackWithNoteRow* modelStackWithNoteRow,
...
void GlobalEffectableParameterAutomation::setVelocity(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void GlobalEffectableParameterAutomation::setVelocityRamp(ModelStackWithNoteRow* modelStackWithNoteRow,
...
void GlobalEffectableParameterAutomation::recordNoteEditPadAction(int32_t x, int32_t velocity) {
...
// stores pad presses in the EditPadPresses struct of the instrument clip view
void GlobalEffectableParameterAutomation::automationEditPadAction(ModelStackWithAutoParam* modelStackWithParam,
...
bool GlobalEffectableParameterAutomation::recordAutomationSinglePadPress(int32_t xDisplay, int32_t yDisplay) {
...
ActionResult
GlobalEffectableParameterAutomation::handleMutePadAction(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
...
ActionResult GlobalEffectableParameterAutomation::handleAuditionPadAction(InstrumentClip* instrumentClip,
                                                                          Output* output, OutputType outputType,
...
void GlobalEffectableParameterAutomation::auditionPadAction(int32_t velocity, int32_t yDisplay, bool shiftButtonDown) {
...
ActionResult GlobalEffectableParameterAutomation::horizontalEncoderAction(int32_t offset) {
	if (sdRoutineLock) {
...
void GlobalEffectableParameterAutomation::shiftAutomationHorizontally(ModelStackWithAutoParam* modelStackWithParam,
...
ActionResult GlobalEffectableParameterAutomation::verticalEncoderAction(int32_t offset, bool inCardRoutine) {
	if (inCardRoutine) {
		return ActionResult::REMIND_ME_OUTSIDE_CARD_ROUTINE;
	}
...
void GlobalEffectableParameterAutomation::potentiallyVerticalScrollToSelectedDrum(InstrumentClip* clip,
                                                                                  Output* output) {
...
// Not used with Audio Clip Automation View or Arranger Automation View
ActionResult GlobalEffectableParameterAutomation::scrollVertical(int32_t scrollAmount) {
	InstrumentClip* clip = getCurrentInstrumentClip();
	Output* output = clip->output;
	OutputType outputType = output->type;
...
void GlobalEffectableParameterAutomation::modEncoderAction(int32_t whichModEncoder, int32_t offset) {
...
bool GlobalEffectableParameterAutomation::automationModEncoderActionForSelectedPad(
...
void GlobalEffectableParameterAutomation::automationModEncoderActionForUnselectedPad(
    ModelStackWithAutoParam* modelStackWithParam, int32_t whichModEncoder, int32_t offset, int32_t effectiveLength) {
	Clip* clip = getCurrentClip();
...
void GlobalEffectableParameterAutomation::modEncoderButtonAction(uint8_t whichModEncoder, bool on) {
...
void GlobalEffectableParameterAutomation::copyAutomation(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                                         int32_t xScroll, int32_t xZoom) {
...
void GlobalEffectableParameterAutomation::pasteAutomation(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
void GlobalEffectableParameterAutomation::selectEncoderAction(int8_t offset) {
...
void GlobalEffectableParameterAutomation::selectGlobalParam(int32_t offset, Clip* clip) {
	if (onArrangerView) {
...
void GlobalEffectableParameterAutomation::selectNonGlobalParam(int32_t offset, Clip* clip) {
...
bool GlobalEffectableParameterAutomation::selectPatchCable(int32_t offset, Clip* clip) {
	ParamManagerForTimeline* paramManager = clip->getCurrentParamManager();
	if (paramManager) {
		PatchCableSet* set = paramManager->getPatchCableSetAllowJibberish();
		// make sure it's not jiberish
...
bool GlobalEffectableParameterAutomation::selectPatchCableAtIndex(Clip* clip, PatchCableSet* set,
                                                                  int32_t patchCableIndex,
...
void GlobalEffectableParameterAutomation::selectMIDICC(int32_t offset, Clip* clip) {
	if (onAutomationOverview()) {
...
int32_t GlobalEffectableParameterAutomation::getNextSelectedParamArrayPosition(int32_t offset,
...
void GlobalEffectableParameterAutomation::getLastSelectedParamShortcut(Clip* clip) {
...
void GlobalEffectableParameterAutomation::getLastSelectedParamArrayPosition(Clip* clip) {
	Output* output = clip->output;
	OutputType outputType = output->type;
...
void GlobalEffectableParameterAutomation::getLastSelectedNonGlobalParamArrayPosition(Clip* clip) {
...
void GlobalEffectableParameterAutomation::getLastSelectedGlobalParamArrayPosition(Clip* clip) {
...
void GlobalEffectableParameterAutomation::noteRowChanged(InstrumentClip* clip, NoteRow* noteRow) {
	instrumentClipView.noteRowChanged(clip, noteRow);
}

// called by playback_handler.cpp
void GlobalEffectableParameterAutomation::notifyPlaybackBegun() {
...
void GlobalEffectableParameterAutomation::initParameterSelection(bool updateDisplay) {
	resetShortcutBlinking();
	initPadSelection();
...
void GlobalEffectableParameterAutomation::initPadSelection() {
	padSelectionOn = false;
	multiPadPressSelected = false;
	multiPadPressActive = false;
	middlePadPressSelected = false;
...
void GlobalEffectableParameterAutomation::initInterpolation() {
...
ModelStackWithAutoParam* GlobalEffectableParameterAutomation::getModelStackWithParamForClip(
    ModelStackWithTimelineCounter* modelStack, Clip* clip, int32_t paramID, params::Kind paramKind) {
	ModelStackWithAutoParam* modelStackWithParam = nullptr;
...
int32_t GlobalEffectableParameterAutomation::getEffectiveLength(ModelStackWithTimelineCounter* modelStack) {
	Clip* clip = getCurrentClip();
	OutputType outputType = clip->output->type;
...
uint32_t GlobalEffectableParameterAutomation::getMaxLength() {
	if (onArrangerView) {
...
uint32_t GlobalEffectableParameterAutomation::getMaxZoom() {
	if (onArrangerView) {
...
int32_t GlobalEffectableParameterAutomation::getNavSysId() const {
	if (onArrangerView) {
...
uint32_t GlobalEffectableParameterAutomation::getSquareWidth(int32_t square, int32_t effectiveLength, int32_t xScroll,
                                                             int32_t xZoom) {
...
uint32_t GlobalEffectableParameterAutomation::getMiddlePosFromSquare(int32_t xDisplay, int32_t effectiveLength,
                                                                     int32_t xScroll, int32_t xZoom) {
...
int32_t GlobalEffectableParameterAutomation::getAutomationParameterKnobPos(ModelStackWithAutoParam* modelStack,
...
bool GlobalEffectableParameterAutomation::getAutomationNodeInterpolation(ModelStackWithAutoParam* modelStack,
...
void GlobalEffectableParameterAutomation::setAutomationParameterValue(ModelStackWithAutoParam* modelStack,
...
void GlobalEffectableParameterAutomation::setAutomationKnobIndicatorLevels(ModelStackWithAutoParam* modelStack,
                                                                           int32_t knobPosLeft, int32_t knobPosRight) {
...
void GlobalEffectableParameterAutomation::updateAutomationModPosition(ModelStackWithAutoParam* modelStack,
...
void GlobalEffectableParameterAutomation::handleAutomationSinglePadPress(ModelStackWithAutoParam* modelStackWithParam,
                                                                         Clip* clip, int32_t xDisplay, int32_t yDisplay,
                                                                         int32_t effectiveLength, int32_t xScroll,
                                                                         int32_t xZoom) {
...
// using the grid
void GlobalEffectableParameterAutomation::handleAutomationParameterChange(ModelStackWithAutoParam* modelStackWithParam,
...
int32_t
GlobalEffectableParameterAutomation::calculateAutomationKnobPosForPadPress(ModelStackWithAutoParam* modelStackWithParam,
...
// presses
int32_t GlobalEffectableParameterAutomation::calculateAutomationKnobPosForMiddlePadPress(params::Kind kind,
                                                                                         int32_t yDisplay) {
	int32_t newKnobPos = 0;
...
int32_t GlobalEffectableParameterAutomation::calculateAutomationKnobPosForSinglePadPress(params::Kind kind,
                                                                                         int32_t yDisplay) {
	int32_t newKnobPos = 0;
...
void GlobalEffectableParameterAutomation::handleAutomationMultiPadPress(
...
void GlobalEffectableParameterAutomation::renderAutomationDisplayForMultiPadPress(
...
int32_t GlobalEffectableParameterAutomation::calculateAutomationKnobPosForModEncoderTurn(
...
bool GlobalEffectableParameterAutomation::onAutomationOverview() {
	return (!inAutomationEditor() && !inNoteEditor());
}

bool GlobalEffectableParameterAutomation::inAutomationEditor() {
	if (onArrangerView) {
...
void GlobalEffectableParameterAutomation::setAutomationParamType() {
	automationParamType = AutomationParamType::PER_SOUND;
	if (!inAutomationEditor()) {
		Clip* clip = getCurrentClip();
...
bool GlobalEffectableParameterAutomation::inNoteEditor() {
	return (automationParamType != AutomationParamType::PER_SOUND);
}

// used to determine the affect entire context
bool GlobalEffectableParameterAutomation::getAffectEntire() {
...
void GlobalEffectableParameterAutomation::blinkShortcuts() {
	if (getCurrentUI() == this) {
...
void GlobalEffectableParameterAutomation::resetShortcutBlinking() {
	memset(soundEditor.sourceShortcutBlinkFrequencies, 255, sizeof(soundEditor.sourceShortcutBlinkFrequencies));
	resetParameterShortcutBlinking();
	resetInterpolationShortcutBlinking();
	resetPadSelectionShortcutBlinking();
...
void GlobalEffectableParameterAutomation::resetParameterShortcutBlinking() {
...
void GlobalEffectableParameterAutomation::resetInterpolationShortcutBlinking() {
	uiTimerManager.unsetTimer(TimerName::INTERPOLATION_SHORTCUT_BLINK);
	interpolationShortcutBlinking = false;
}

void GlobalEffectableParameterAutomation::blinkInterpolationShortcut() {
...
void GlobalEffectableParameterAutomation::resetPadSelectionShortcutBlinking() {
	uiTimerManager.unsetTimer(TimerName::PAD_SELECTION_SHORTCUT_BLINK);
	padSelectionShortcutBlinking = false;
}

void GlobalEffectableParameterAutomation::blinkPadSelectionShortcut() {
