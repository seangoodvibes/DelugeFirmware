...
#include "gui/views/automation/type/parameter/midi.h"
...
MidiParameterAutomation midiParameterAutomation{};
...
void MidiParameterAutomation::initMIDICCShortcutsForAutomation() {
...
bool MidiParameterAutomation::opened() {
	initializeView();
...
void MidiParameterAutomation::initializeView() {
...
void MidiParameterAutomation::focusRegained() {
	if (onArrangerView) {
...
void MidiParameterAutomation::openedInBackground() {
	Clip* clip = getCurrentClip();
	...
	AudioEngine::logAction("MidiParameterAutomation::beginSession 2");
...
void MidiParameterAutomation::graphicsRoutine() {
	if (onArrangerView) {
...
AutomationSubType MidiParameterAutomation::getAutomationSubType() {
	if (onArrangerView) {
...
// rendering
bool MidiParameterAutomation::possiblyRefreshAutomationEditorGrid(Clip* clip, params::Kind paramKind, int32_t paramID) {
...
bool MidiParameterAutomation::renderMainPads(uint32_t whichRows, RGB image[][kDisplayWidth + kSideBarWidth],
...
void MidiParameterAutomation::performActualRender(RGB image[][kDisplayWidth + kSideBarWidth],
                                                  uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void MidiParameterAutomation::renderAutomationOverview(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
...
void MidiParameterAutomation::renderAutomationEditor(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                                     RGB image[][kDisplayWidth + kSideBarWidth],
                                                     uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void MidiParameterAutomation::renderAutomationColumn(ModelStackWithAutoParam* modelStackWithParam,
                                                     RGB image[][kDisplayWidth + kSideBarWidth],
                                                     uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void MidiParameterAutomation::renderAutomationBipolarSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                                            uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
void MidiParameterAutomation::renderAutomationUnipolarSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                                             uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
                                                             int32_t xDisplay, int32_t yDisplay, bool isAutomated,
                                                             int32_t knobPos) {
	RGB& pixel = image[yDisplay][xDisplay];
...
void MidiParameterAutomation::renderNoteEditor(ModelStackWithNoteRow* modelStackWithNoteRow, InstrumentClip* clip,
                                               RGB image[][kDisplayWidth + kSideBarWidth],
                                               uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
                                               int32_t renderWidth, int32_t xScroll, uint32_t xZoom,
                                               int32_t effectiveLength, int32_t xDisplay, bool drawUndefinedArea,
...
void MidiParameterAutomation::renderNoteColumn(ModelStackWithNoteRow* modelStackWithNoteRow, InstrumentClip* clip,
                                               RGB image[][kDisplayWidth + kSideBarWidth],
...
void MidiParameterAutomation::renderNoteSquare(RGB image[][kDisplayWidth + kSideBarWidth],
                                               uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth], int32_t xDisplay,
...
void MidiParameterAutomation::renderUndefinedArea(int32_t xScroll, uint32_t xZoom, int32_t lengthToDisplay,
                                                  RGB image[][kDisplayWidth + kSideBarWidth],
                                                  uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth],
...
bool MidiParameterAutomation::renderSidebar(uint32_t whichRows, RGB image[][kDisplayWidth + kSideBarWidth],
                                            uint8_t occupancyMask[][kDisplayWidth + kSideBarWidth]) {
	if (onArrangerView) {
...
void MidiParameterAutomation::renderDisplay(int32_t knobPosLeft, int32_t knobPosRight, bool modEncoderAction) {
...
void MidiParameterAutomation::renderDisplayOLED(Clip* clip, Output* output, OutputType outputType, int32_t knobPosLeft,
...
void MidiParameterAutomation::renderAutomationOverviewDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void MidiParameterAutomation::renderAutomationEditorDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void MidiParameterAutomation::renderNoteEditorDisplayOLED(deluge::hid::display::oled_canvas::Canvas& canvas,
...
void MidiParameterAutomation::renderDisplay7SEG(Clip* clip, Output* output, OutputType outputType, int32_t knobPosLeft,
...
void MidiParameterAutomation::renderAutomationOverviewDisplay7SEG(Output* output, OutputType outputType) {
	char const* overviewText;
	if (!onArrangerView && (outputType == OutputType::KIT && !getAffectEntire() && !((Kit*)output)->selectedDrum)) {
		overviewText = l10n::get(l10n::String::STRING_FOR_SELECT_A_ROW_OR_AFFECT_ENTIRE);
	}
...
void MidiParameterAutomation::renderAutomationEditorDisplay7SEG(Clip* clip, OutputType outputType, int32_t knobPosLeft,
                                                                bool modEncoderAction) {
	char modelStackMemory[MODEL_STACK_MAX_SIZE];
	ModelStackWithTimelineCounter* modelStack = currentSong->setupModelStackWithCurrentClip(modelStackMemory);
	ModelStackWithAutoParam* modelStackWithParam = nullptr;
...
void MidiParameterAutomation::renderNoteEditorDisplay7SEG(InstrumentClip* clip, OutputType outputType,
                                                          int32_t knobPosLeft) {
	char modelStackMemory[MODEL_STACK_MAX_SIZE];
	ModelStackWithTimelineCounter* modelStack = currentSong->setupModelStackWithCurrentClip(modelStackMemory);
	bool isKit = outputType == OutputType::KIT;
...
void MidiParameterAutomation::getAutomationParameterName(Clip* clip, OutputType outputType, StringBuf& parameterName) {
...
void MidiParameterAutomation::displayAutomation(bool padSelected, bool updateDisplay) {
...
ActionResult MidiParameterAutomation::buttonAction(hid::Button b, bool on, bool inCardRoutine) {
	if (inCardRoutine) {
...
void MidiParameterAutomation::handleSessionButtonAction(Clip* clip, bool on) {
...
void MidiParameterAutomation::handleKeyboardButtonAction(bool on) {
...
void MidiParameterAutomation::handleClipButtonAction(bool on, bool isAudioClip) {
...
void MidiParameterAutomation::handleCrossScreenButtonAction(bool on) {
...
void MidiParameterAutomation::handleKitButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
...
void MidiParameterAutomation::handleSynthButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		// if you're going to create a new instrument or change output type,
		// reset selection
		initParameterSelection();
...
void MidiParameterAutomation::handleMidiButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
...
void MidiParameterAutomation::handleCVButtonAction(OutputType outputType, bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		// if you're going to change output type,
		// reset selection
		initParameterSelection();
...
bool MidiParameterAutomation::handleHorizontalEncoderButtonAction(bool on, bool isAudioClip) {
	if (onArrangerView) {
		return true;
	}
	else if (isAudioClip) {
...
bool MidiParameterAutomation::handleBackAndHorizontalEncoderButtonComboAction(Clip* clip, bool on) {
...
void MidiParameterAutomation::handleVerticalEncoderButtonAction(bool on) {
	if (on) {
		if (inNoteEditor()) {
...
void MidiParameterAutomation::handleSelectEncoderButtonAction(bool on) {
	if (on && (currentUIMode == UI_MODE_NONE || (currentUIMode == UI_MODE_NOTES_PRESSED && padSelectionOn))) {
		initParameterSelection();
		uiNeedsRendering(this);
...
ActionResult MidiParameterAutomation::padAction(int32_t x, int32_t y, int32_t velocity) {
	if (sdRoutineLock) {
		return ActionResult::REMIND_ME_OUTSIDE_CARD_ROUTINE;
	}
...
ActionResult MidiParameterAutomation::handleEditPadAction(ModelStackWithAutoParam* modelStackWithParam,
                                                          ModelStackWithNoteRow* modelStackWithNoteRow,
...
bool MidiParameterAutomation::shortcutPadAction(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
bool MidiParameterAutomation::toggleAutomationInterpolation() {
	if (interpolation) {
		interpolation = false;
		initInterpolation();
...
bool MidiParameterAutomation::toggleVelocityPadSelectionMode(SquareInfo& squareInfo) {
...
bool MidiParameterAutomation::toggleAutomationPadSelectionMode(ModelStackWithAutoParam* modelStackWithParam,
...
void MidiParameterAutomation::handleParameterSelection(Clip* clip, Output* output, OutputType outputType,
...
void MidiParameterAutomation::noteEditPadAction(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void MidiParameterAutomation::velocityPadSelectionAction(ModelStackWithNoteRow* modelStackWithNoteRow,
                                                         InstrumentClip* clip, int32_t x, int32_t y, int32_t velocity,
                                                         SquareInfo& squareInfo) {
...
void MidiParameterAutomation::velocityEditPadAction(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
                                                    InstrumentClip* clip, int32_t x, int32_t y, int32_t velocity,
                                                    int32_t effectiveLength, SquareInfo& squareInfo) {
	// save pad selected
	leftPadSelectedX = x;
...
int32_t MidiParameterAutomation::getVelocityFromY(int32_t y) {
	int32_t velocity = std::clamp<int32_t>(nonPatchCablePadPressValues[y], 1, 127);
	return velocity;
}

// convert velocity of a square into y
int32_t MidiParameterAutomation::getYFromVelocity(int32_t velocity) {
...
// add note and set velocity
void MidiParameterAutomation::addNoteWithNewVelocity(int32_t x, int32_t velocity, int32_t newVelocity) {
	if (velocity) {
...
void MidiParameterAutomation::adjustNoteVelocity(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void MidiParameterAutomation::setVelocity(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow, int32_t x,
                                          int32_t newVelocity) {
...
void MidiParameterAutomation::setVelocityRamp(ModelStackWithNoteRow* modelStackWithNoteRow, NoteRow* noteRow,
...
void MidiParameterAutomation::recordNoteEditPadAction(int32_t x, int32_t velocity) {
...
// stores pad presses in the EditPadPresses struct of the instrument clip view
void MidiParameterAutomation::automationEditPadAction(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
bool MidiParameterAutomation::recordAutomationSinglePadPress(int32_t xDisplay, int32_t yDisplay) {
...
ActionResult MidiParameterAutomation::handleMutePadAction(ModelStackWithTimelineCounter* modelStackWithTimelineCounter,
...
ActionResult MidiParameterAutomation::handleAuditionPadAction(InstrumentClip* instrumentClip, Output* output,
                                                              OutputType outputType, int32_t y, int32_t velocity) {
	if (onArrangerView) {
		if (onAutomationOverview()) {
...
void MidiParameterAutomation::auditionPadAction(int32_t velocity, int32_t yDisplay, bool shiftButtonDown) {
...
ActionResult MidiParameterAutomation::horizontalEncoderAction(int32_t offset) {
	if (sdRoutineLock) {
...
void MidiParameterAutomation::shiftAutomationHorizontally(ModelStackWithAutoParam* modelStackWithParam, int32_t offset,
...
ActionResult MidiParameterAutomation::verticalEncoderAction(int32_t offset, bool inCardRoutine) {
	if (inCardRoutine) {
		return ActionResult::REMIND_ME_OUTSIDE_CARD_ROUTINE;
	}
...
void MidiParameterAutomation::potentiallyVerticalScrollToSelectedDrum(InstrumentClip* clip, Output* output) {
...
// Not used with Audio Clip Automation View or Arranger Automation View
ActionResult MidiParameterAutomation::scrollVertical(int32_t scrollAmount) {
	InstrumentClip* clip = getCurrentInstrumentClip();
	Output* output = clip->output;
	OutputType outputType = output->type;
...
void MidiParameterAutomation::modEncoderAction(int32_t whichModEncoder, int32_t offset) {
...
bool MidiParameterAutomation::automationModEncoderActionForSelectedPad(ModelStackWithAutoParam* modelStackWithParam,
...
void MidiParameterAutomation::automationModEncoderActionForUnselectedPad(ModelStackWithAutoParam* modelStackWithParam,
                                                                         int32_t whichModEncoder, int32_t offset,
                                                                         int32_t effectiveLength) {
	Clip* clip = getCurrentClip();
...
void MidiParameterAutomation::modEncoderButtonAction(uint8_t whichModEncoder, bool on) {
...
void MidiParameterAutomation::copyAutomation(ModelStackWithAutoParam* modelStackWithParam, Clip* clip, int32_t xScroll,
                                             int32_t xZoom) {
...
void MidiParameterAutomation::pasteAutomation(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                              int32_t effectiveLength, int32_t xScroll, int32_t xZoom) {
	if (!copiedParamAutomation.nodes) {
...
void MidiParameterAutomation::selectEncoderAction(int8_t offset) {
...
void MidiParameterAutomation::selectGlobalParam(int32_t offset, Clip* clip) {
	if (onArrangerView) {
...
void MidiParameterAutomation::selectNonGlobalParam(int32_t offset, Clip* clip) {
...
bool MidiParameterAutomation::selectPatchCable(int32_t offset, Clip* clip) {
	ParamManagerForTimeline* paramManager = clip->getCurrentParamManager();
	if (paramManager) {
		PatchCableSet* set = paramManager->getPatchCableSetAllowJibberish();
		// make sure it's not jiberish
...
bool MidiParameterAutomation::selectPatchCableAtIndex(Clip* clip, PatchCableSet* set, int32_t patchCableIndex,
...
void MidiParameterAutomation::selectMIDICC(int32_t offset, Clip* clip) {
	if (onAutomationOverview()) {
...
int32_t MidiParameterAutomation::getNextSelectedParamArrayPosition(int32_t offset,
...
void MidiParameterAutomation::getLastSelectedParamShortcut(Clip* clip) {
...
void MidiParameterAutomation::getLastSelectedParamArrayPosition(Clip* clip) {
	Output* output = clip->output;
	OutputType outputType = output->type;
...
void MidiParameterAutomation::getLastSelectedNonGlobalParamArrayPosition(Clip* clip) {
...
void MidiParameterAutomation::getLastSelectedGlobalParamArrayPosition(Clip* clip) {
...
void MidiParameterAutomation::noteRowChanged(InstrumentClip* clip, NoteRow* noteRow) {
	instrumentClipView.noteRowChanged(clip, noteRow);
}

// called by playback_handler.cpp
void MidiParameterAutomation::notifyPlaybackBegun() {
...
void MidiParameterAutomation::initParameterSelection(bool updateDisplay) {
	resetShortcutBlinking();
	initPadSelection();
...
void MidiParameterAutomation::initPadSelection() {
	padSelectionOn = false;
	multiPadPressSelected = false;
	multiPadPressActive = false;
	middlePadPressSelected = false;
...
void MidiParameterAutomation::initInterpolation() {
...
MidiParameterAutomation::getModelStackWithParamForClip(ModelStackWithTimelineCounter* modelStack, Clip* clip,
...
int32_t MidiParameterAutomation::getEffectiveLength(ModelStackWithTimelineCounter* modelStack) {
	Clip* clip = getCurrentClip();
	OutputType outputType = clip->output->type;
...
uint32_t MidiParameterAutomation::getMaxLength() {
	if (onArrangerView) {
...
uint32_t MidiParameterAutomation::getMaxZoom() {
	if (onArrangerView) {
...
int32_t MidiParameterAutomation::getNavSysId() const {
	if (onArrangerView) {
...
uint32_t MidiParameterAutomation::getSquareWidth(int32_t square, int32_t effectiveLength, int32_t xScroll,
                                                 int32_t xZoom) {
...
uint32_t MidiParameterAutomation::getMiddlePosFromSquare(int32_t xDisplay, int32_t effectiveLength, int32_t xScroll,
                                                         int32_t xZoom) {
...
int32_t MidiParameterAutomation::getAutomationParameterKnobPos(ModelStackWithAutoParam* modelStack,
...
bool MidiParameterAutomation::getAutomationNodeInterpolation(ModelStackWithAutoParam* modelStack, int32_t pos,
                                                             bool reversed) {
...
void MidiParameterAutomation::setAutomationParameterValue(ModelStackWithAutoParam* modelStack, int32_t knobPos,
...
void MidiParameterAutomation::setAutomationKnobIndicatorLevels(ModelStackWithAutoParam* modelStack, int32_t knobPosLeft,
                                                               int32_t knobPosRight) {
...
void MidiParameterAutomation::updateAutomationModPosition(ModelStackWithAutoParam* modelStack, uint32_t squareStart,
...
void MidiParameterAutomation::handleAutomationSinglePadPress(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
                                                             int32_t xDisplay, int32_t yDisplay,
                                                             int32_t effectiveLength, int32_t xScroll, int32_t xZoom) {
...
// using the grid
void MidiParameterAutomation::handleAutomationParameterChange(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
int32_t MidiParameterAutomation::calculateAutomationKnobPosForPadPress(ModelStackWithAutoParam* modelStackWithParam,
...
// presses
int32_t MidiParameterAutomation::calculateAutomationKnobPosForMiddlePadPress(params::Kind kind, int32_t yDisplay) {
	int32_t newKnobPos = 0;
...
int32_t MidiParameterAutomation::calculateAutomationKnobPosForSinglePadPress(params::Kind kind, int32_t yDisplay) {
	int32_t newKnobPos = 0;
...
void MidiParameterAutomation::handleAutomationMultiPadPress(ModelStackWithAutoParam* modelStackWithParam, Clip* clip,
...
void MidiParameterAutomation::renderAutomationDisplayForMultiPadPress(ModelStackWithAutoParam* modelStackWithParam,
...
int32_t
MidiParameterAutomation::calculateAutomationKnobPosForModEncoderTurn(ModelStackWithAutoParam* modelStackWithParam,
...
bool MidiParameterAutomation::onAutomationOverview() {
	return (!inAutomationEditor() && !inNoteEditor());
}

bool MidiParameterAutomation::inAutomationEditor() {
	if (onArrangerView) {
...
void MidiParameterAutomation::setAutomationParamType() {
	automationParamType = AutomationParamType::PER_SOUND;
	if (!inAutomationEditor()) {
		Clip* clip = getCurrentClip();
...
void MidiParameterAutomation::blinkShortcuts() {
	if (getCurrentUI() == this) {
...
void MidiParameterAutomation::resetShortcutBlinking() {
	memset(soundEditor.sourceShortcutBlinkFrequencies, 255, sizeof(soundEditor.sourceShortcutBlinkFrequencies));
	resetParameterShortcutBlinking();
	resetInterpolationShortcutBlinking();
	resetPadSelectionShortcutBlinking();
...
void MidiParameterAutomation::resetParameterShortcutBlinking() {
...
void MidiParameterAutomation::resetInterpolationShortcutBlinking() {
	uiTimerManager.unsetTimer(TimerName::INTERPOLATION_SHORTCUT_BLINK);
	interpolationShortcutBlinking = false;
}

void MidiParameterAutomation::blinkInterpolationShortcut() {
...
void MidiParameterAutomation::resetPadSelectionShortcutBlinking() {
	uiTimerManager.unsetTimer(TimerName::PAD_SELECTION_SHORTCUT_BLINK);
	padSelectionShortcutBlinking = false;
}

void MidiParameterAutomation::blinkPadSelectionShortcut() {
