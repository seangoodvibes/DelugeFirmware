...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_TOTAL_VOICE_COUNT, "TOTL"},
        {STRING_FOR_SYNTH_CLIP_VOICE_COUNT, "SYNT"},
        {STRING_FOR_KIT_CLIP_VOICE_COUNT, "KIT"},
        {STRING_FOR_AUDIO_CLIP_VOICE_COUNT, "AUD"},
        {STRING_FOR_NO_ACTIVE_CLIPS, "NONE"},
