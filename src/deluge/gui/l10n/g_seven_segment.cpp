...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_CPU_USAGE_TOTAL, "TOTL"},
        {STRING_FOR_CPU_USAGE_SYNTH, "SYNT"},
        {STRING_FOR_CPU_USAGE_KIT, "KIT"},
        {STRING_FOR_CPU_USAGE_AUDIO, "AUDI"},
        {STRING_FOR_CPU_USAGE, "CPU"},
        {STRING_FOR_VOICE_USAGE, "VOIC"},
        {STRING_FOR_VOICE_RAW_USAGE, "RAWV"},
        {STRING_FOR_VOICE_UNISON_USAGE, "UNIS"},
        {STRING_FOR_FX_USAGE, "FX"},
        {STRING_FOR_FX_DELAY_USAGE, "DELY"},
        {STRING_FOR_FILTER_USAGE, "FLTR"},
        {STRING_FOR_FX_GRAIN_USAGE, "GRFX"},
        {STRING_FOR_OSC_DX7_USAGE, "DX7"},
        {STRING_FOR_OSC_LIVE_PITCH_USAGE, "LPIT"},
        {STRING_FOR_OSC_SAMPLE_USAGE, "SAMP"},
        {STRING_FOR_OSC_SAMPLE_RAW_USAGE, "RAWS"},
        {STRING_FOR_OSC_SAMPLE_STRETCH_USAGE, "STRE"},
        {STRING_FOR_OSC_SAMPLE_CACHE_USAGE, "CACH"},
        {STRING_FOR_OSC_WAVETABLE_USAGE, "WAVT"},
