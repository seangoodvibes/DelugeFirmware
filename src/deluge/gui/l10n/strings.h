...
enum class String : size_t {
	...
	STRING_FOR_TOTAL_VOICE_COUNT,
	STRING_FOR_SYNTH_CLIP_VOICE_COUNT,
	STRING_FOR_KIT_CLIP_VOICE_COUNT,
	STRING_FOR_AUDIO_CLIP_VOICE_COUNT,
	STRING_FOR_NO_ACTIVE_CLIPS,
