...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_VOICE_RAW_USAGE, "Raw Usage"},
        {STRING_FOR_VOICE_UNISON_USAGE, "Unison Usage"},
        {STRING_FOR_FX_USAGE, "FX Usage"},
        {STRING_FOR_FX_DELAY_USAGE, "Delay Usage"},
        {STRING_FOR_FILTER_USAGE, "Filter Usage"},
        {STRING_FOR_FX_GRAIN_USAGE, "Grain Usage"},
        {STRING_FOR_OSC_DX7_USAGE, "DX7 Usage"},
        {STRING_FOR_OSC_LIVE_PITCH_USAGE, "Live Pitch Shift Usage"},
        {STRING_FOR_OSC_SAMPLE_USAGE, "Sample Usage"},
        {STRING_FOR_OSC_SAMPLE_STRETCH_USAGE, "Sample Stretch Usage"},
        {STRING_FOR_OSC_SAMPLE_CACHE_USAGE, "Sample Cache Usage"},
