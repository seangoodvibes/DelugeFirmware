...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_CPU_USAGE, "CPU Usage"},
        {STRING_FOR_CPU_USAGE_TOTAL, "Total"},
        {STRING_FOR_CPU_USAGE_SONG, "Song"},
        {STRING_FOR_CPU_USAGE_SYNTH, "Synth"},
        {STRING_FOR_CPU_USAGE_KIT, "Kit"},
        {STRING_FOR_CPU_USAGE_AUDIO, "Audio"},
        {STRING_FOR_VOICE_USAGE, "Voice Usage"},
        {STRING_FOR_VOICE_RAW_USAGE, "Voice: Raw"},
        {STRING_FOR_VOICE_UNISON_USAGE, "Voice: Unison"},
        {STRING_FOR_FX_USAGE, "FX Usage"},
        {STRING_FOR_FX_DELAY_USAGE, "FX: Delay"},
        {STRING_FOR_FILTER_USAGE, "Filter Usage"},
        {STRING_FOR_FX_GRAIN_USAGE, "FX: Grain"},
        {STRING_FOR_OSC_DX7_USAGE, "DX7 Usage"},
        {STRING_FOR_OSC_LIVE_PITCH_USAGE, "Live Pitchshift"},
        {STRING_FOR_OSC_SAMPLE_USAGE, "Sample Usage"},
        {STRING_FOR_OSC_SAMPLE_RAW_USAGE, "Sample: Raw"},
        {STRING_FOR_OSC_SAMPLE_STRETCH_USAGE, "Sample: Stretch"},
        {STRING_FOR_OSC_SAMPLE_CACHE_USAGE, "Sample: Cache"},
        {STRING_FOR_OSC_WAVETABLE_USAGE, "Wavetable Usage"},
