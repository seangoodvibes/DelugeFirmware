...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_TOTAL_VOICE_COUNT, "Total Voice Count"},
        {STRING_FOR_SYNTH_CLIP_VOICE_COUNT, "Synth Clip Voice Count"},
        {STRING_FOR_KIT_CLIP_VOICE_COUNT, "Kit Clip Voice Count"},
        {STRING_FOR_AUDIO_CLIP_VOICE_COUNT, "Audio Clip Voice Count"},
        {STRING_FOR_NO_ACTIVE_CLIPS, "No active clips"},
