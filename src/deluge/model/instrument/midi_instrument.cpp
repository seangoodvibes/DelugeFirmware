...
void MIDIInstrument::sendMonophonicExpressionEvent(int32_t whichExpressionDimension) {
	...
	case BREATH: {
		int32_t value = lastMonoExpression[whichExpressionDimension] >> 24;
		// send CC2 for monophonic expression

		midiEngine.sendCC(masterChannel, CC_NUMBER_BREATH, value, channel);
		break;
	}
	case EXPRESSION_1: {
		int32_t value = lastMonoExpression[whichExpressionDimension] >> 24;
		...
		midiEngine.sendCC(masterChannel, CC_NUMBER_EXPRESSION_1, value, channel);
		break;
	}
	case EXPRESSION_2: {
		int32_t value = lastMonoExpression[whichExpressionDimension] >> 24;
	...
	case EXPRESSION_3: {
		...
		midiEngine.sendCC(masterChannel, CC_NUMBER_EXPRESSION_3, value, channel);
		break;
	}
	default:
