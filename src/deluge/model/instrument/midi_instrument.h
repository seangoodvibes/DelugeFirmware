...
public:
	...
	// cc names
	Error readDeviceDefinitionFile(Deserializer& reader, bool readLabels = false);
	Error readCCLabelsFromFile(Deserializer& reader, bool readLabels = false);
	void writeDeviceDefinitionFile(Serializer& writer, bool writeFileName = true);
	void writeCCLabelsToFile(Serializer& writer, bool writeFileName = true);
