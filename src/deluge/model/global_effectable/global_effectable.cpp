...
void GlobalEffectable::compensateVolumeForResonance(ParamManagerForTimeline* paramManager) {
	...
	if (!unpatchedParams->isAutomated(params::UNPATCHED_LPF_FREQ)
		...
		unpatchedParams->setCurrentValueBasicForSetup(params::UNPATCHED_LPF_RES, -2147483648);
	}
	...
	if (!unpatchedParams->containsSomething(params::UNPATCHED_HPF_FREQ, -2147483648)
		...
		unpatchedParams->setCurrentValueBasicForSetup(params::UNPATCHED_HPF_RES, -2147483648);
	}
}
