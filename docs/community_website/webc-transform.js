		...
		async function (content) {
			...
			try {
				...
				for (let helperName in eleventyConfig.javascriptFunctions) {
					page.setHelper(
						helperName,
						eleventyConfig.javascriptFunctions[helperName],
						scopedHelpers.has(helperName)
					)
				}
				...
				page.setContent(content, "_site/lol.md")
				...
				console.error(
					`[11ty/eleventy-plugin-webc] Error transforming ${this.inputPath}`,
					e
				)
				throw e
			}
